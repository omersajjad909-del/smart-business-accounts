...
// â”€â”€ Pre-built notification helpers â”€â”€
...
export const whatsappNotifications = {
  ...
  paymentReminder: (phone: string, customerName: string, invoiceNo: string, amount: string, daysOverdue: number) =>
    sendWhatsApp({
      to: phone,
      message: `Hi ${customerName},\n\nâš ï¸ Reminder: Invoice ${invoiceNo} for ${amount} is ${daysOverdue > 0 ? `${daysOverdue} days overdue` : "due today"}.\n\nPlease arrange payment at your earliest convenience.\n\nâ€” Finova`,
    }),
  ...
  welcome: (phone: string, name: string, companyName: string) =>
    sendWhatsApp({
      to: phone,
      message: `Welcome to Finova, ${name}! ðŸŽ‰\n\nYour ${companyName} workspace is ready.\n\nðŸš€ Get started: ${(process.env.NEXT_PUBLIC_APP_URL || "https://usefinova.app")}/dashboard\n\nNeed help? Reply to this message.\n\nâ€” The Finova Team`,
    }),
