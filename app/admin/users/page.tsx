...
// "ADMIN" here means "owner of their own company" (every signup gets this
// role) — this page lists those users normally. Only true platform admins
// (role=ADMIN with zero companies) are excluded; see /api/admin/users/all.
