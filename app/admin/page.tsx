...
const NAV_ICONS: Record<string, React.ReactNode> = {
  ...
  dev_test:         <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M9 3H5a2 2 0 0 0-2 2v4m6-6h10a2 2 0 0 1 2 2v4M9 3v18m0 0h10a2 2 0 0 0 2-2v-4M9 21H5a2 2 0 0 1-2-2v-4m0 0h18"/></svg>,
  automation:       <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg>,
  marketing_autopilot: <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><path d="M8.56 2.75c4.37 6.03 6.02 9.42 8.03 17.72m2.54-15.38c-3.72 4.35-8.94 5.66-16.88 5.85m19.5 1.9c-3.5-.93-6.63-.82-8.94 0-2.58.92-5.01 2.86-7.44 6.32"/></svg>,
...
const NAV: { page:Page; label:string; icon:string; color:string; badge?:string }[] = [
  ...
  { page:"companies",        label:"Companies",        icon:"",  color:"#38bdf8" },
  { page:"users",            label:"Users",            icon:"",  color:"#60a5fa" },
  { page:"subscriptions",    label:"Subscriptions",    icon:"",  color:"#fbbf24" },
  { page:"plans",            label:"Plans",            icon:"",  color:"#818cf8" },
  { page:"business_modules", label:"Modules",          icon:"",  color:"#a78bfa" },
  ...
  { page:"permissions",      label:"Roles & Permissions", icon:"", color:"#f87171" },
  { page:"settings",         label:"Settings",         icon:"",  color:"#94a3b8" },
  { page:"system",           label:"System Health",    icon:"",  color:"#34d399", badge:"OK" },
  { page:"logs",             label:"Activity Logs",    icon:"",  color:"#94a3b8" },
  ...
  { page:"automation",       label:"Automation",       icon:"",  color:"#a78bfa", badge:"NEW" },
  { page:"marketing_autopilot", label:"Autopilot",    icon:"",  color:"#f472b6", badge:"AI" },
  ...
  { page:"dev_test",         label:"Dev Test Mode",    icon:"",  color:"#a78bfa", badge:"DEV" },
...
const NAV_GROUPS: { label: string; pages: Page[] }[] = [
  { label: "Main",      pages: ["dashboard","companies","users","subscriptions","plans","business_modules"] },
  { label: "Business",  pages: ["revenue","geo","usage","visitors","signup_analytics","crm","leads","broadcasts","newsletter","social","feedback","testimonials"] },
  { label: "System",    pages: ["permissions","settings","system","logs","emaillogs"] },
  { label: "Others",    pages: ["coupons","referrals","automation","marketing_autopilot","updates","seo","livesupport","tickets","fraud","dev_test","flags","apikeys","teams"] },
];
...
function PagePlans() {
  ...
  return (
    <div style={{ display:"flex", flexDirection:"column", gap:18 }}>
      ...
      {plansTab === "modules" && <PageModulePrices customPlan={customPlan} setCustomPlan={setCustomPlan} onSave={savePricing} saved={saved} />}
    </div>
  );
}
                ...
                {groupItems.map(item => {
                  ...
                  return (
                    <button key={item.page}
                      className="nav-btn"
                      onClick={() => { if (item.page === "fraud") { window.location.href = "/admin/fraud"; return; } if (item.page === "dev_test") { window.location.href = "/admin/dev-test"; return; } if (item.page === "automation") { window.location.href = "/admin/automation"; return; } if (item.page === "marketing_autopilot") { window.location.href = "/admin/marketing-autopilot"; return; } setPage(item.page); setMobileOpen(false); }}
