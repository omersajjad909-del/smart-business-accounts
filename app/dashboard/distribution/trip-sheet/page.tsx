      ...
      <div style={{ background: distributionBg, border: `1px solid ${distributionBorder}`, borderRadius: 16, padding: 24, marginBottom: 24 }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 20 }}>
          ...
          <div style={{ textAlign: "right" }}>
            <div style={{ fontSize: 12, color: "rgba(var(--ink),var(--ta-45, .45))" }}>Trip Date</div>
              ...
              <thead>
                <tr>
                  {["Customer", "Invoice", "Items", "Status"].map((header) => (
                    <th key={header} style={{ textAlign: "left", padding: "10px 12px", fontSize: 12, color: "rgba(var(--ink),var(--ta-50, .5))", borderBottom: `1px solid ${distributionBorder}` }}>{header}</th>
                  ))}
                </tr>
              </thead>
              <tbody>
                ...
                {deliveries.length === 0 && (
                  <tr>
                    <td colSpan={4} style={{ padding: 20, textAlign: "center", color: "rgba(var(--ink),var(--ta-25, .25))" }}>No deliveries for this selection.</td>
                  </tr>
                )}
              </tbody>
            </table>
          ...
          <div>
            ...
            <table style={{ width: "100%", borderCollapse: "collapse" }}>
              ...
              <tbody>
                ...
                {stockLoads.length === 0 && (
                  <tr>
                    <td colSpan={4} style={{ padding: 20, textAlign: "center", color: "rgba(var(--ink),var(--ta-25, .25))" }}>No load sheet data for this selection.</td>
                  </tr>
                )}
              </tbody>
            </table>
