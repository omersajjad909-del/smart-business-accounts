    ...
    <div style={S.page}>
      ...
      <div style={S.kpiGrid}>
        ...
        <div style={S.kpi}>
          ...
          <div style={{ ...S.kpiVal, color: "var(--tx-34d399, #34d399)" }}>{kpis.billableHours.toFixed(1)}</div>
        </div>
        <div style={S.kpi}>
          <div style={S.kpiLabel}>Revenue</div>
          <div style={{ ...S.kpiVal, color: "var(--tx-818cf8, #818cf8)" }}>${kpis.revenue.toLocaleString()}</div>
        </div>
        <div style={S.kpi}>
          <div style={S.kpiLabel}>Non-Billable Hours</div>
          <div style={{ ...S.kpiVal, color: "var(--tx-f87171, #f87171)" }}>{kpis.nonBillable.toFixed(1)}</div>
        </div>
      </div>
