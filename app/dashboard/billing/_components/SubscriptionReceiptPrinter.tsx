          ...
          >
            ...
            <div
              style={{
                height: 9,
                background: "#fdfdfb",
                clipPath: "polygon(0 0,100% 0,100% 0,97.5% 100%,95% 0,92.5% 100%,90% 0,87.5% 100%,85% 0,82.5% 100%,80% 0,77.5% 100%,50% 0,72.5% 100%,70% 0,67.5% 100%,65% 0,62.5% 100%,60% 0,57.5% 100%,55% 0,52.5% 100%,50% 0,47.5% 100%,45% 0,42.5% 100%,40% 0,37.5% 100%,35% 0,32.5% 100%,30% 0,27.5% 100%,25% 0,22.5% 100%,20% 0,17.5% 100%,15% 0,12.5% 100%,10% 0,7.5% 100%,5% 0,2.5% 100%,0 0)",
              }}
            />
          </div>
        </div>
