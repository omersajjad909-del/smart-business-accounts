        ...
        <div style={{ padding: isMobile ? "12px 12px" : "22px 26px", display: "flex", alignItems: "center", gap: 18, flexWrap: "wrap" }}>
          ...
          <div style={{ flex: 1, minWidth: 220 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 10, flexWrap: "wrap", marginBottom: 4 }}>
              <h2 style={{ margin: 0, fontSize: 18, fontWeight: 800, color: "var(--ink-solid, white)" }}>Business Automation Add-on</h2>
      ...
      {loading ? (
        ...
        <div style={{ overflowX: "auto" as const }}>
          <table style={{ width: "100%", borderCollapse: "collapse", fontSize: isMobile ? 12 : 13 }}>
            ...
            <tbody>
              {rows.map(row => (
                <tr key={row.id} style={{ borderTop: "1px solid rgba(var(--ink),0.06)" }}>
