    ...
    <div style={{ padding: isMobile ? "15px 14px" : "28px 32px", fontFamily: ff, color: "var(--ink-solid, #fff)", minHeight: "100vh" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 26 }}>
        <div>
          ...
          <p style={{ fontSize: 13, color: "rgba(var(--ink),var(--ta-42, .42))", margin: 0 }}>Issue shop-floor production based on BOMs and push completed orders into finished goods.</p>
        </div>
        ...
        {orders.map((order) => {
          ...
          return (
            <div key={order.id} style={{ background: bg, border: `1px solid ${border}`, borderRadius: 14, padding: isMobile ? "12px 10px" : "18px 22px" }}>
              ...
              <div style={{ fontSize: 12, color: "rgba(var(--ink),var(--ta-50, .5))", marginBottom: 10 }}>
          ...
          <div style={{ background: "var(--dk-161b27, #161b27)", border: `1px solid ${border}`, borderRadius: 16, padding: 30, width: 540, fontFamily: ff }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
              <div style={{ gridColumn: "span 2" }}>
                <label style={{ display: "block", fontSize: 12, color: "rgba(var(--ink),var(--ta-45, .45))", marginBottom: 6 }}>Product</label>
              ...
              <div style={{ gridColumn: "span 2" }}>
                <label style={{ display: "block", fontSize: 12, color: "rgba(var(--ink),var(--ta-45, .45))", marginBottom: 6 }}>Linked BOM</label>
              ...
              <div>
                <label style={{ display: "block", fontSize: 12, color: "rgba(var(--ink),var(--ta-45, .45))", marginBottom: 6 }}>Quantity</label>
              ...
              <div>
                <label style={{ display: "block", fontSize: 12, color: "rgba(var(--ink),var(--ta-45, .45))", marginBottom: 6 }}>Planned Date</label>
              ...
              <div>
                <label style={{ display: "block", fontSize: 12, color: "rgba(var(--ink),var(--ta-45, .45))", marginBottom: 6 }}>Consume from</label>
              ...
              <div>
                <label style={{ display: "block", fontSize: 12, color: "rgba(var(--ink),var(--ta-45, .45))", marginBottom: 6 }}>Assigned To</label>
            ...
            <div style={{ display: "flex", gap: 12, marginTop: 18 }}>
              ...
              <button onClick={() => setShowModal(false)} style={{ padding: "11px 24px", background: "transparent", border: `1px solid ${border}`, borderRadius: 8, color: "rgba(var(--ink),var(--ta-65, .65))", cursor: "pointer" }}>Cancel</button>
            </div>
          </div>
        </div>
      )}
      ...
      {runOrder && (
        <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,.7)", zIndex: 50, display: "flex", alignItems: "center", justifyContent: "center", padding: 16 }}>
          <div style={{ background: "var(--dk-161b27, #161b27)", border: `1px solid ${border}`, borderRadius: 16, padding: 28, width: 620, maxHeight: "90vh", overflowY: "auto", fontFamily: ff }}>
            ...
            <div style={{ fontSize: 12.5, color: "rgba(var(--ink),var(--ta-42, .42))", marginBottom: 18 }}>
            ...
            <div style={{ display: "flex", gap: 14, flexWrap: "wrap", marginBottom: 16 }}>
              <div>
                ...
                <label style={{ display: "block", fontSize: 12, color: "rgba(var(--ink),var(--ta-45, .45))", marginBottom: 6 }}>Finished today</label>
                <input
                ...
                <div style={{ fontSize: 11, color: "rgba(var(--ink),var(--ta-35, .35))", marginTop: 6, width: 180, lineHeight: 1.6 }}>
              ...
              <div>
                <label style={{ display: "block", fontSize: 12, color: "rgba(var(--ink),var(--ta-45, .45))", marginBottom: 6 }}>Production date</label>
                <input
            ...
            {quoting && <div style={{ fontSize: 13, color: "rgba(var(--ink),var(--ta-40, .4))", padding: "12px 0" }}>Costing this run…</div>}
            ...
            {runQuote && !quoting && (
              <>
                    ...
                    <thead>
                      <tr style={{ background: "rgba(var(--ink),.03)" }}>
                        {["Material", "Needs", "Open stock", "Off the rack", "Cost"].map((h, i) => (
                          <th key={h} style={{ padding: "10px 14px", fontSize: 11, fontWeight: 700, color: "rgba(var(--ink),var(--ta-40, .4))", textTransform: "uppercase", letterSpacing: ".05em", textAlign: i === 0 ? "left" : "right" }}>{h}</th>
                        ))}
                      </tr>
                    </thead>
                    <tbody>
                      {runQuote.lines.map((line) => {
                        ...
                        return (
                          <tr key={line.itemId} style={{ borderTop: `1px solid ${border}` }}>
                            ...
                            <td style={{ padding: "10px 14px", fontSize: 12.5, textAlign: "right", color: "rgba(var(--ink),var(--ta-62, .62))" }}>{line.exactQty.toFixed(2)}{line.unit}</td>
                            <td style={{ padding: "10px 14px", fontSize: 12.5, textAlign: "right", color: line.fromRemnantQty > 0 ? "var(--tx-34d399, #34d399)" : "rgba(var(--ink),var(--ta-25, .25))" }}>
                            ...
                            <td style={{ padding: "10px 14px", fontSize: 12.5, textAlign: "right", fontWeight: 700 }}>
                              ...
                              <div style={{ fontSize: 11, fontWeight: 400, color: short ? "var(--tx-fca5a5, #fca5a5)" : "rgba(var(--ink),var(--ta-35, .35))", marginTop: 3 }}>
                                have {line.availableQty}{line.unit}
                              </div>
                            </td>
                            <td style={{ padding: "10px 14px", fontSize: 12.5, textAlign: "right", color: "rgba(var(--ink),var(--ta-62, .62))" }}>Rs. {Math.round(line.lineCost).toLocaleString()}</td>
                          </tr>
                        );
                      })}
                    </tbody>
                ...
                {runQuote.shortages.length > 0 && (
                  <div style={{ marginBottom: 14, padding: "12px 14px", borderRadius: 10, background: "rgba(239,68,68,.1)", border: "1px solid rgba(239,68,68,.26)" }}>
                    ...
                    {runQuote.shortages.some((l) => (l.elsewhere?.length ?? 0) > 0) && (
                      <div style={{ fontSize: 12, color: "rgba(var(--ink),var(--ta-60, .6))", marginBottom: 8, lineHeight: 1.7 }}>
                    ...
                    <label style={{ display: "flex", alignItems: "center", gap: 8, fontSize: 12, color: "rgba(var(--ink),var(--ta-55, .55))", cursor: "pointer" }}>
                ...
                <div style={{ border: `1px solid ${border}`, borderRadius: 12, padding: "14px 16px", marginBottom: 14 }}>
                  ...
                  {!labourList.length && (
                    <div style={{ fontSize: 12, color: "rgba(var(--ink),var(--ta-35, .35))", marginBottom: 8 }}>
                    ...
                    {labourRows.map((row, index) => (
                      <div key={index} style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr 1fr" : "1fr 1fr 84px 92px 28px", gap: 8, alignItems: "center" }}>
                        ...
                        {/* Out of the tab order entirely. Deleting a row is a
                            ...
                            way past. */}
                        <button onClick={() => removeLabourRow(index)} tabIndex={-1} title="Remove" style={{ background: "transparent", border: `1px solid ${border}`, borderRadius: 8, color: "rgba(var(--ink),var(--ta-45, .45))", cursor: "pointer", padding: "7px 0", gridColumn: isMobile ? "1 / -1" : "auto" }}>×</button>
                      </div>
                    ))}
                  </div>
                  ...
                  <button id="po-add-worker" onClick={addLabourRow} style={{ marginTop: 8, padding: "6px 12px", borderRadius: 8, background: "rgba(var(--ink),.05)", border: `1px solid ${border}`, color: "rgba(var(--ink),var(--ta-65, .65))", fontSize: 11.5, fontWeight: 600, cursor: "pointer" }}>
                    + Add worker
                  </button>
                  <div style={{ fontSize: 11, color: "rgba(var(--ink),var(--ta-32, .32))", marginTop: 8, lineHeight: 1.7 }}>
                ...
                {jobNamesMissing && (
                  <div style={{ padding: "12px 14px", borderRadius: 12, background: "rgba(239,68,68,.12)", border: "1px solid rgba(239,68,68,.3)", marginBottom: 14 }}>
                    ...
                    <div style={{ fontSize: 11.5, color: "rgba(var(--ink),var(--ta-50, .5))", lineHeight: 1.7 }}>
                ...
                {!jobNamesMissing && labourPieces && labourPieces.over.length > 0 && (
                  <div style={{ padding: "12px 14px", borderRadius: 12, background: "rgba(56,189,248,.08)", border: "1px solid rgba(56,189,248,.25)", marginBottom: 14, fontSize: 12, color: "rgba(var(--ink),var(--ta-60, .6))", lineHeight: 1.7 }}>
                ...
                <div style={{ padding: "14px 16px", borderRadius: 12, background: "rgba(34,197,94,.08)", border: "1px solid rgba(34,197,94,.22)", marginBottom: 8 }}>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: 8 }}>
                    <span style={{ fontSize: 12.5, color: "rgba(var(--ink),var(--ta-50, .5))" }}>Total cost of this run</span>
                  ...
                  <div style={{ display: "flex", justifyContent: "space-between", fontSize: 12, color: "rgba(var(--ink),var(--ta-42, .42))" }}>
                  ...
                  <div style={{ display: "flex", justifyContent: "space-between", fontSize: 12, color: "rgba(var(--ink),var(--ta-55, .55))", fontWeight: 700, marginTop: 6 }}>
                    <span>Per unit</span><span>Rs. {runQuote.unitCost.toFixed(2)}</span>
                  </div>
                </div>

                <div style={{ fontSize: 11.5, color: "rgba(var(--ink),var(--ta-35, .35))", lineHeight: 1.7, marginBottom: 16 }}>
            ...
            <div style={{ display: "flex", gap: 12 }}>
              ...
              <button onClick={() => { setRunOrder(null); setRunQuote(null); setAllowShort(false); }} style={{ padding: "11px 24px", background: "transparent", border: `1px solid ${border}`, borderRadius: 8, color: "rgba(var(--ink),var(--ta-65, .65))", cursor: "pointer" }}>Cancel</button>
            </div>
          </div>
        </div>
      )}
