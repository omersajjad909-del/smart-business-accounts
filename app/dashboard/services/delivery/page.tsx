            ...
            <div style={{ textAlign: "right" }}>
              ...
              <div style={{ display: "flex", gap: 8, justifyContent: "flex-end", marginTop: 10 }}>
                ...
                {delivery.status === "in_review" && (
                  <button onClick={() => moveDeliveryStatus(delivery.id, "completed", delivery.projectCode)} style={{ padding: isMobile ? "8px 8px" : "5px 10px", background: "rgba(34,197,94,.15)", border: "1px solid rgba(34,197,94,.3)", color: "#22c55e", borderRadius: 6, fontSize: 11, cursor: "pointer" }}>
                    Complete
                  </button>
                )}
              </div>
          ...
          <div style={{ width: 520, background: "var(--dk-161b27, #161b27)", border: `1px solid ${border}`, borderRadius: 16, padding: 28 }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", gap: 14 }}>
              ...
              <div>
                ...
                }} style={{ width: "100%", background: "var(--dk-161b27, #161b27)", border: `1px solid ${border}`, borderRadius: 8, padding: isMobile ? "8px 8px" : "9px 12px", color: "var(--ink-solid, #fff)" }}>
