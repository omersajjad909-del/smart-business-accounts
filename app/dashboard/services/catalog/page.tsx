    ...
    <div style={{ padding: isMobile ? "15px 14px" : "28px 32px", fontFamily: ff, color: "var(--ink-solid, #fff)", minHeight: "100vh" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 24 }}>
        <div>
          ...
          <p style={{ fontSize: 13, color: "rgba(var(--ink),.42)", margin: 0 }}>Define service lines, rates, and expected turnaround.</p>
        </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "repeat(auto-fill,minmax(260px,1fr))", gap: 14 }}>
        ...
        {!store.loading && services.length === 0 && <div style={{ color: "rgba(var(--ink),.3)" }}>No services configured yet.</div>}
      </div>
          ...
          <div style={{ width: 520, background: "var(--dk-161b27, #161b27)", border: `1px solid ${border}`, borderRadius: 16, padding: 28 }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
              <div style={{ gridColumn: "span 2" }}>
                <label style={{ display: "block", marginBottom: 6, fontSize: 12, color: "rgba(var(--ink),.45)" }}>Service Name</label>
              ...
              <div>
                <label style={{ display: "block", marginBottom: 6, fontSize: 12, color: "rgba(var(--ink),.45)" }}>Billing Type</label>
              ...
              <div>
                <label style={{ display: "block", marginBottom: 6, fontSize: 12, color: "rgba(var(--ink),.45)" }}>Rate</label>
              ...
              <div style={{ gridColumn: "span 2" }}>
                <label style={{ display: "block", marginBottom: 6, fontSize: 12, color: "rgba(var(--ink),.45)" }}>Turnaround Days</label>
              ...
              <div style={{ gridColumn: "span 2" }}>
                <label style={{ display: "block", marginBottom: 6, fontSize: 12, color: "rgba(var(--ink),.45)" }}>Scope</label>
            ...
            <div style={{ display: "flex", gap: 12, marginTop: 18 }}>
              ...
              <button onClick={() => setShowModal(false)} style={{ padding: "11px 24px", borderRadius: 8, border: `1px solid ${border}`, background: "transparent", color: "rgba(var(--ink),.65)", cursor: "pointer" }}>Cancel</button>
            </div>
          </div>
        </div>
      )}
