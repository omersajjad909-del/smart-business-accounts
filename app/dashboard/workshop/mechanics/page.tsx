  ...
  return (
    <div style={{ padding: "32px 24px", color: "var(--text-primary)", fontFamily: "inherit" }}>
      <div style={{ marginBottom: 28 }}>
        ...
        <p style={{ fontSize: 14, color: "rgba(255,255,255,0.45)", margin: 0 }}>Manage mechanics, their job assignments and performance.</p>
      </div>
      <div style={{
        ...
        <div style={{ fontSize: 18, fontWeight: 700, color: "white", marginBottom: 8 }}>Mechanics</div>
        <div style={{ fontSize: 14, color: "rgba(255,255,255,0.35)", maxWidth: 400, margin: "0 auto" }}>
          Manage mechanics, their job assignments and performance.
        </div>
      </div>
    </div>
  );
