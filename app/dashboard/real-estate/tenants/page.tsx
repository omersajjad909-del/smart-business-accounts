...
const s = {
  ...
  sub: { color: "rgba(var(--ink),var(--ta-45, .45))", fontSize: 13, marginBottom: 28 } as React.CSSProperties,
  ...
  cardLabel: { fontSize: 12, color: "rgba(var(--ink),var(--ta-45, .45))", marginBottom: 8, textTransform: "uppercase" as const, letterSpacing: 1 },
  ...
  tSub: { fontSize: 12, color: "rgba(var(--ink),var(--ta-40, .4))" } as React.CSSProperties,
  ...
  infoItem: { fontSize: 12, color: "rgba(var(--ink),var(--ta-50, .5))" } as React.CSSProperties,
  ...
  dpLabel: { fontSize: 12, color: "rgba(var(--ink),var(--ta-40, .4))" } as React.CSSProperties,
  ...
  lbl: { fontSize: 12, color: "rgba(var(--ink),var(--ta-50, .5))", marginBottom: 6, display: "block" } as React.CSSProperties,
  ...
  cancelBtn: { background: "transparent", color: "rgba(var(--ink),var(--ta-60, .6))", border: "1px solid rgba(var(--ink),.1)", borderRadius: 10, padding: "10px 22px", fontSize: 14, cursor: "pointer" } as React.CSSProperties,
};
      ...
      <div style={s.mainLayout}>
        <div>
          ...
          {!loading && tenants.length === 0 && (
            <div style={{ ...s.card, textAlign: "center", padding: 40, color: "rgba(var(--ink),var(--ta-25, .25))" }}>No tenants found.</div>
          )}
