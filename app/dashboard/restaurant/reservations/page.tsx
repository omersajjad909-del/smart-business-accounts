    ...
    <div style={{ padding: isMobile ? "15px 14px" : "28px 32px", color: "var(--ink-solid, #fff)", fontFamily: restaurantFont, minHeight: "100vh" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 26 }}>
        <div>
          ...
          <p style={{ fontSize: 13, color: "rgba(var(--ink),.45)", margin: 0 }}>Track table bookings from booking to arrival.</p>
        </div>
        ...
        <table style={{ width: "100%", borderCollapse: "collapse" }}>
          ...
          <tbody>
            ...
            {!reservationStore.loading && reservations.length === 0 && (
              <tr>
                <td colSpan={7} style={{ padding: 36, textAlign: "center", color: "rgba(var(--ink),.25)" }}>No reservations yet.</td>
              </tr>
            )}
          </tbody>
        </table>
        ...
        <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,.72)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 40 }}>
          <div style={{ width: 520, background: "var(--dk-161b27, #161b27)", border: `1px solid ${restaurantBorder}`, borderRadius: 16, padding: 28 }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
              ...
              <div>
                <label style={{ display: "block", fontSize: 12, color: "rgba(var(--ink),.45)", marginBottom: 6 }}>Reservation Date</label>
