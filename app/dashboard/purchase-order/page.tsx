                        ...
                        {rows.map((r, i) => {
                          ...
                          return (
                            ...
                            if (rfActive) {
                              ...
                              <td style={{ padding: isMobile ? "8px 8px" : "6px 7px", width: 64 }}><input type="number" step="any" value={r.qty} onChange={e => updateRow(i, "qty", e.target.value)} placeholder="0" style={inp({ padding: isMobile ? "8px 8px" : "5px 7px", textAlign: "right", fontSize: 13 })} /></td>
