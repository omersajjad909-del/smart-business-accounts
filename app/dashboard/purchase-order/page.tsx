...
export default function PODesign({
  poNo,
  date,
  supplierName,
  items,
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-4 md:p-8 font-sans">
      ...
      <div className="max-w-5xl mx-auto bg-white rounded-2xl shadow-xl overflow-hidden">
        ...
        {/* Header */}
        <div className="border-b px-6 py-5 flex flex-col md:flex-row justify-between gap-4">
          <div>
          ...
          <div className="text-sm space-y-1">
            <div><span className="text-gray-500">PO #:</span> <b>{poNo}</b></div>
        ...
        <div className="px-6 py-6 flex flex-col md:flex-row justify-between gap-6">
          ...
          {/* Amount Box */}
          <div className="w-full md:w-72 bg-gray-50 rounded-xl p-4 border">
        ...
        {/* Footer */}
        <div className="border-t px-6 py-4 text-xs text-gray-500 flex justify-between">
      ...
      <div className="mt-10 flex justify-center">
        <div className="w-[360px] border-4 border-black rounded-[30px] overflow-hidden shadow-2xl">
          <div className="bg-white text-xs p-2 text-center border-b">
            Mobile Preview
          </div>
          <div className="scale-[0.85] origin-top">
            {/* reuse same design */}
            <div className="p-2">
              <div className="text-sm font-bold">PO #{poNo}</div>
