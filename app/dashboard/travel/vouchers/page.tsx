      ...
      <div style={{ padding: isMobile ? "14px 12px" : "24px 28px", fontFamily: ff }}>
        <div className="no-print" style={{ display: "flex", gap: 10, marginBottom: 18 }}>
          ...
          <button onClick={() => setPreviewing(null)}
            style={{ padding: "9px 18px", borderRadius: 9, background: "transparent", border: `1px solid ${border}`, color: "rgba(var(--ink),var(--ta-65, .65))", fontSize: 13, fontFamily: "inherit", cursor: "pointer" }}>
            Back
          </button>
        </div>
    ...
    return (
      <div style={{ padding: isMobile ? "14px 12px" : "24px 28px", fontFamily: ff, color: "var(--ink-solid, #fff)", maxWidth: 1080 }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", gap: 14, flexWrap: "wrap" }}>
          ...
          <div style={{ fontSize: 12.5, color: "rgba(var(--ink),var(--ta-42, .42))" }}>
              ...
              <div key={stay.id} style={{ background: bg, border: `1px solid ${border}`, borderRadius: 12, padding: 12 }}>
                <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr 1fr" : mina ? "120px 1.5fr 1.2fr 100px 1fr 1fr 80px 30px" : "120px 1.5fr 96px 1fr 1fr 110px 80px 90px 30px", gap: 9, alignItems: "end" }}>
                  ...
                  <div>
                    ...
                    <div style={{ ...input, background: "rgba(56,189,248,.08)", borderColor: "rgba(56,189,248,.3)", color: nights ? accent : "rgba(var(--ink),var(--ta-30, .3))", fontWeight: 700, textAlign: "center" }}>
                      {nights || "—"}
                    </div>
                  </div>
                ...
                {!mina ? <label style={{ display: "flex", alignItems: "center", gap: 8, fontSize: 11.5, color: "rgba(var(--ink),var(--ta-45, .45))", marginTop: 8, cursor: "pointer" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", gap: 12 }}>
          ...
          <label style={{ display: "grid", gap: 4, gridColumn: "1 / -1" }}>
            <span style={{ fontSize: 10.5, fontWeight: 700, letterSpacing: ".05em", textTransform: "uppercase", color: "rgba(var(--ink),var(--ta-40, .4))" }}>
              Terms &amp; Conditions
            </span>
            <textarea
              value={v.terms || ""}
            ...
            <span style={{ display: "flex", gap: 10, flexWrap: "wrap", alignItems: "center" }}>
              ...
              <span style={{ fontSize: 10.5, color: "rgba(var(--ink),var(--ta-38, .38))" }}>
