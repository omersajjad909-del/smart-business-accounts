      ...
      {!showModal && (
        <>
          ...
          {data && !loading && (
            <>
              {/* Report header */}
              <div style={{ border:"1px solid rgba(var(--ink),.08)", borderRadius:16, padding: isMobile ? "15px 14px" : "28px 32px", marginBottom:20, background:"linear-gradient(135deg,rgba(59,130,246,.1),rgba(37,99,235,.05))" }}>
                  ...
                  <table style={{ width:"100%", borderCollapse:"collapse" }}>
                    ...
                    <tbody>
                      ...
                      {data.netProfit !== undefined && (() => {
                        ...
                        return (
                          <tr style={{ borderBottom:"1px solid rgba(var(--ink),.04)", background: isProfit ? "rgba(52,211,153,.05)" : "rgba(248,113,113,.05)" }}>
