        ...
        <div style={{ background: itBg, border: `1px solid ${itBorder}`, borderRadius: 20, padding: 22 }}>
          ...
          <div style={{ display: "grid", gap: 10 }}>
            {projects.length === 0 ? (
              ...
              <div key={project.id} style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 10, background: "rgba(var(--ink),.025)", border: "1px solid rgba(var(--ink),.06)", borderRadius: 14, padding: "12px 14px" }}>
                <div>
