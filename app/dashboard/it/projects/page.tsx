    ...
    <div style={S.page}>
      ...
      <div style={S.grid}>
        {!loading && filtered.length === 0 && (
          <div style={{ ...S.card, textAlign: 'center', padding: 40, color: 'rgba(var(--ink),var(--ta-25, .25))', gridColumn: '1/-1' }}>No projects found.</div>
        )}
        {filtered.map(p => {
            ...
            <div key={p.id} style={S.card}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 8 }}>
                <div>
                  ...
                  <div style={{ fontSize: 13, color: 'rgba(var(--ink),var(--ta-50, .5))', marginTop: 2 }}>{p.client}</div>
                </div>
