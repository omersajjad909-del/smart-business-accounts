    ...
    <div style={{ padding:"24px 28px", fontFamily:ff, color:"rgba(255,255,255,.85)", maxWidth:1100 }}>
      ...
      <div style={{ background:"rgba(255,255,255,.03)", border:"1px solid rgba(255,255,255,.08)", borderRadius:16, padding:24, marginBottom:28 }}>
              ...
              {entries.map((row, i) => {
                ...
                return (
                  <tr key={row.id} style={{ borderBottom:"1px solid rgba(255,255,255,.05)" }}>
                    ...
                    <td style={{ padding:"6px 8px" }}>
                      <input value={row.amount} onChange={e => setEntryField(row.id, "amount", e.target.value)} placeholder="0.00" type="number" min="0" style={{ ...inp, fontSize:13, fontWeight:700, textAlign:"right", color:BLUE }} />
                    </td>
                    <td style={{ padding:"6px 8px", textAlign:"center" }}>
                      <div style={{ display:"flex", gap:4, justifyContent:"center" }}>
                        ...
                        <button
                          ...
                          style={{ padding:"4px 8px", borderRadius:6, background:"rgba(99,102,241,.1)", border:"1px solid rgba(99,102,241,.25)", color:BLUE, fontSize:11, fontWeight:700, cursor:"pointer", fontFamily:ff, opacity:(!row.accountId || !Number(row.amount)) ? 0.3 : 1 }}
                        >🧾</button>
                        {/* Delete row */}
        ...
        <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between", flexWrap:"wrap", gap:12 }}>
          <button onClick={addRow} style={{ padding:"8px 18px", borderRadius:8, background:"rgba(99,102,241,.08)", border:"1px solid rgba(99,102,241,.2)", color:BLUE, fontSize:13, fontWeight:700, cursor:"pointer", fontFamily:ff }}>
            + Add Row
          </button>
