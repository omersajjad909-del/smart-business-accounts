        ...
        {recipeStore.loading ? (
          ...
          <table style={{ width: "100%", borderCollapse: "collapse" }}>
            ...
            <tbody>
              {recipes.map((item) => (
                <tr key={item.id}>
                  <td style={{ padding: "14px 12px 14px 0", borderBottom: "1px solid rgba(var(--ink),.04)", fontSize: 13 }}>{item.recipe}</td>
                  <td style={{ padding: "14px 12px 14px 0", borderBottom: "1px solid rgba(var(--ink),.04)", fontSize: 13 }}>{item.sku || "-"}</td>
                  <td style={{ padding: "14px 12px 14px 0", borderBottom: "1px solid rgba(var(--ink),.04)", fontSize: 13 }}>{Number(item.batchYield || 0).toLocaleString()}</td>
                  <td style={{ padding: "14px 12px 14px 0", borderBottom: "1px solid rgba(var(--ink),.04)", fontSize: 13 }}>{Number(item.unitCost || 0).toLocaleString()}</td>
