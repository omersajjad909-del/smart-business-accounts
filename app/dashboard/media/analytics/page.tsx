      ...
      <div style={{ display: "grid", gridTemplateColumns: "1.1fr .9fr", gap: 16 }}>
        <div style={{ background: "rgba(var(--ink),.03)", border: "1px solid rgba(var(--ink),.07)", borderRadius: 16, padding: 20 }}>
          ...
          {campaignStore.loading ? (
            <div style={{ fontSize: 13, color: "rgba(var(--ink),.45)" }}>Loading campaigns...</div>
          ) : campaigns.length ? (
            ...
            <div style={{ fontSize: 13, color: "rgba(var(--ink),.45)" }}>No campaigns available yet.</div>
          )}
        </div>
        ...
        <div style={{ display: "grid", gap: 16 }}>
          <div style={{ background: "rgba(var(--ink),.03)", border: "1px solid rgba(var(--ink),.07)", borderRadius: 16, padding: 20 }}>
            ...
            )) : <div style={{ fontSize: 13, color: "rgba(var(--ink),.45)" }}>No clients available yet.</div>}
          </div>
          ...
          <div style={{ background: "rgba(var(--ink),.03)", border: "1px solid rgba(var(--ink),.07)", borderRadius: 16, padding: 20 }}>
            ...
            )) : <div style={{ fontSize: 13, color: "rgba(var(--ink),.45)" }}>No media plans available yet.</div>}
          </div>
        </div>
      </div>
    </div>
