      ...
      <div style={{ marginTop: 18, background: gymBg, border: `1px solid ${gymBorder}`, borderRadius: 20, padding: 22 }}>
        ...
        <div style={{ display: "grid", gap: 10 }}>
          {trainerLoad.length === 0 ? (
            ...
            <div key={trainer.id} style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 10, background: "rgba(var(--ink),.025)", border: "1px solid rgba(var(--ink),.06)", borderRadius: 14, padding: "12px 14px" }}>
              <div>
