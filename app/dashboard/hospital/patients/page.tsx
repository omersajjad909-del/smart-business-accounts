      ...
      <div style={{ display: "grid", gridTemplateColumns: selectedPatient ? "1fr 380px" : "1fr", gap: 20 }}>
            ...
            <tbody>
              ...
              {filtered.map(p => (
                <tr key={p.id} onClick={() => setSelected(p.id === selected ? null : p.id)} style={{ borderBottom: `1px solid ${border}`, cursor: "pointer", background: selected === p.id ? "rgba(59,130,246,0.08)" : "transparent", transition: "background 0.15s" }}>
                  ...
                  <td style={{ padding: "13px 16px" }}>
                    <span style={{ color: p.insurance ? "#22c55e" : "rgba(255,255,255,0.3)", fontSize: 16 }}>{p.insurance ? "Ã¢Å“â€œ" : "Ã¢Å“â€”"}</span>
                  </td>
                </tr>
              ))}
            </tbody>
        ...
        {selectedPatient && (
          <div style={{ ...card, position: "relative" }}>
            <button onClick={() => setSelected(null)} style={{ position: "absolute", top: 16, right: 16, background: "transparent", border: "none", color: "rgba(255,255,255,0.5)", fontSize: 18, cursor: "pointer" }}>Ã¢Å“â€¢</button>
        ...
        <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.7)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 50 }}>
          <div style={{ background: "#161b27", border: `1px solid ${border}`, borderRadius: 16, padding: 32, width: 540, maxHeight: "85vh", overflowY: "auto", fontFamily: ff }}>
            <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 24 }}>
              ...
              <button onClick={() => setShowModal(false)} style={{ background: "none", border: "none", color: "rgba(255,255,255,0.5)", fontSize: 20, cursor: "pointer" }}>Ã¢Å“â€¢</button>
            </div>
