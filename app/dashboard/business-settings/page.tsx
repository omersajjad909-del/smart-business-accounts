...
const BIZ_LABELS: Record<string,{label:string;icon:string;color:string}> = {
  ...
  import_export:    {label:"Import Company",        icon:"🚢",color:"#fb923c"},
  export:           {label:"Export Company",        icon:"🌍",color:"#a78bfa"},
  clearing_agent:   {label:"Clearing & Forwarding", icon:"✈️",color:"#f472b6"},
