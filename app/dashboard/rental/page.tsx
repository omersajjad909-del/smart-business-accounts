    ...
    <div style={{ padding: isMobile ? "17px 16px" : "28px 32px", color: "#e2e8f0", fontFamily: "'Outfit','Inter',sans-serif" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: 20, flexWrap: "wrap", marginBottom: 24 }}>
        ...
        <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
          <Link prefetch={false} href="/dashboard/rental/bookings" style={{ padding: isMobile ? "8px 8px" : "10px 14px", borderRadius: 10, border: "1px solid rgba(255,255,255,.08)", background: "rgba(255,255,255,.03)", color: "#86efac", textDecoration: "none", fontSize: 12, fontWeight: 700 }}>Bookings</Link>
          <Link prefetch={false} href="/dashboard/rental/agreements" style={{ padding: isMobile ? "8px 8px" : "10px 14px", borderRadius: 10, border: "1px solid rgba(255,255,255,.08)", background: "rgba(255,255,255,.03)", color: "#86efac", textDecoration: "none", fontSize: 12, fontWeight: 700 }}>Agreements</Link>
        </div>
      </div>
        ...
        <section style={{ background: "rgba(255,255,255,.03)", border: "1px solid rgba(255,255,255,.07)", borderRadius: 16, padding: 20 }}>
          ...
          <div style={{ display: "grid", gap: 10 }}>
            {data.bookings.slice(0, 6).map((item) => (
              <div key={item.id} style={{ padding: isMobile ? "8px 8px" : "10px 12px", borderRadius: 10, background: "rgba(255,255,255,.03)", border: "1px solid rgba(255,255,255,.05)" }}>
