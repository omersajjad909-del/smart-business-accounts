              ...
              <tr key={p.id} style={{ borderBottom: "1px solid rgba(var(--ink),.04)" }}>
                <td style={{ padding: "8px 12px 8px 16px", width: 56 }}>
                  {p.imageUrl
                    ...
                    : <div style={{ width: 48, height: 48, borderRadius: 8, background: "rgba(var(--ink),.05)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 20 }}>🖼</div>
                  }
                </td>
            ...
            <div style={{ marginBottom: 20 }}>
              ...
              <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
                ...
                <input type="number" min={1} max={100} value={catPrintQty} onChange={e => setCatPrintQty(Math.max(1, Math.min(100, Number(e.target.value))))}
                  style={{ width: 70, padding: "8px 0", borderRadius: 8, border: `1px solid ${border}`, background: "rgba(var(--ink),.05)", color: "var(--ink-solid, #fff)", fontSize: 16, fontWeight: 700, textAlign: "center", outline: "none" }} />
                <button onClick={() => setCatPrintQty(q => Math.min(100, q + 1))} style={{ width: 36, height: 36, borderRadius: 8, border: `1px solid ${border}`, background: "rgba(var(--ink),.05)", color: "var(--ink-solid, #fff)", fontSize: 18, cursor: "pointer" }}>+</button>
