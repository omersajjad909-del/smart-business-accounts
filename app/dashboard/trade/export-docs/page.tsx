...
const s = {
  ...
  tabBtn: (active: boolean) => ({ background: active ? "#10b981" : "rgba(var(--ink),.06)", border: `1px solid ${active ? "#10b981" : "var(--border)"}`, borderRadius: 8, padding: "7px 14px", color: active ? "#fff" : "var(--text-muted)", fontFamily: FONT, cursor: "pointer", fontSize: 12, fontWeight: 600, whiteSpace: "nowrap" as const }),
};
