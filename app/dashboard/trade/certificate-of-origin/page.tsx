...
const s = {
  ...
  tabBtn: (active: boolean) => ({ background: active ? "#f59e0b" : "rgba(var(--ink),.06)", border: `1px solid ${active ? "#f59e0b" : "var(--border)"}`, borderRadius: 8, padding: "7px 14px", color: active ? "#fff" : "var(--text-muted)", fontFamily: FONT, cursor: "pointer", fontSize: 12, fontWeight: 600, whiteSpace: "nowrap" as const }),
};
            ...
            <div style={{ marginBottom: 16 }}>
              ...
              <div style={{ border: "1px solid var(--border)", borderRadius: 10, overflow: "hidden" }}>
                <table style={{ width: "100%", borderCollapse: "collapse" }}>
                  <thead>
                    <tr style={{ background: "rgba(var(--ink),.04)" }}>
