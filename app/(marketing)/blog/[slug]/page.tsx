...
const ALL_POSTS: Record<string, any> = {
  "bank-reconciliation-guide": {
    ...
    content: [
      ...
      { type:"p", text:"FinovaOS supports CSV/Excel import from all major banks worldwide. For UAE businesses, ADCB and Emirates NBD formats are also supported, and UK bank formats including Barclays and HSBC are fully compatible. Direct bank feed connections are coming in Q2 2025." },
  ...
  "2": {
    ...
    content: [
      { type:"intro", text:"FinovaOS's HR & Payroll module handles everything from employee onboarding to monthly payslips, statutory contribution calculations, and income tax withholding — all in one place. Here's how to set it up for your business." },
      { type:"h2", text:"Step 1: Add Your Employees" },
      { type:"p", text:"Go to HR → Employees → Add Employee. Fill in the employee's personal details, designation, department, date of joining, and base salary. FinovaOS automatically calculates statutory contributions based on local regulations." },
      { type:"h2", text:"Step 2: Configure Salary Components" },
      { type:"p", text:"For each employee, set up their salary structure: basic salary, housing allowance, transport, medical allowance, and any other allowances. FinovaOS uses this to calculate gross salary and applicable deductions." },
      { type:"h2", text:"Step 3: Statutory Contributions Setup" },
      { type:"p", text:"FinovaOS automatically calculates statutory contributions based on your country's requirements. Both employee and employer contribution rates are applied and updated whenever regulations change." },
      { type:"h2", text:"Step 4: Income Tax Configuration" },
      { type:"p", text:"FinovaOS applies the applicable income tax bands automatically for your jurisdiction. For each employee, the annual salary is calculated, tax is computed at the correct rate, and divided by 12 for monthly deduction. Tax certificates are generated automatically at year end." },
      { type:"h2", text:"Step 5: Run Monthly Payroll" },
      { type:"p", text:"Go to HR → Payroll → Run Payroll, select the month, review all calculations, and approve. FinovaOS generates individual payslips for every employee, posts the payroll journal entry to your accounts, and marks salaries as paid." },
      { type:"list", items:[
        "Statutory contribution reports — ready for regulatory submission",
        "Region-specific compliance rules",
        "Gratuity accrual tracking — automatic calculation",
      ...
      { type:"quote", text:"We had a labour dispute over gratuity miscalculation. Since FinovaOS, every calculation is automatic and documented. Zero disputes in 18 months.", author:"HR Manager, Manufacturing Company" },
    ],
  },
  ...
  "5": {
    ...
    content: [
      { type:"intro", text:"Tax filing doesn't have to be a last-minute panic. FinovaOS generates tax authority-compatible reports throughout the year so that when filing season arrives, everything is ready. Here's how to use FinovaOS for seamless tax compliance." },
      { type:"h2", text:"Sales Tax / GST Reports" },
      { type:"p", text:"Every sales invoice in FinovaOS tracks tax amounts by tax code. At month end, go to Reports → Tax → Sales Tax Summary. FinovaOS generates a detailed report of all taxable sales, tax collected, and net payable — in the format required by your local tax authority." },
      { type:"h2", text:"Income Tax Withholding (Salary)" },
      { type:"p", text:"FinovaOS's payroll module deducts income tax from employee salaries every month. At year end, generate the Annual Tax Certificates for all employees directly from HR → Reports → Tax Certificates." },
      { type:"h2", text:"Withholding Tax on Suppliers" },
      { type:"p", text:"When you pay a supplier who is subject to withholding tax, FinovaOS automatically calculates and deducts the applicable rate. Monthly withholding tax statements are generated automatically for submission to your tax authority." },
      { type:"h2", text:"Annual Accounts for Tax Filing" },
      { type:"p", text:"FinovaOS's Balance Sheet, Profit & Loss, and Cash Flow statements are formatted for direct use in tax filing. Your tax consultant can access these reports directly — no reformatting needed." },
      { type:"list", items:[
      ...
      { type:"quote", text:"Our chartered accountant was amazed. Every report he needed for tax filing was already in FinovaOS, correctly formatted. Filing took 2 hours instead of 2 days.", author:"CEO, Import/Export Company" },
    ],
  },
  ...
  "10": {
    ...
    content: [
      { type:"intro", text:"Pakistan's SME sector — 3.2 million businesses — is rapidly shifting from manual registers and Excel sheets to cloud accounting. But not all accounting software is built for the Pakistani market. Here's what to look for in 2026." },
      { type:"h2", text:"1. FBR Compliance Built In" },
      { type:"p", text:"The #1 requirement for any Pakistani business is FBR (Federal Board of Revenue) compliance. Your accounting software must generate Sales Tax returns (Form ST-3), Withholding Tax statements, and Income Tax (salary) certificates that FBR accepts. FinovaOS generates all FBR-compatible reports automatically." },
      { type:"h2", text:"2. PKR & Multi-Currency Support" },
      { type:"p", text:"Pakistani businesses dealing internationally need PKR as their base currency with USD, AED, EUR, and GBP support. FinovaOS handles all of these with auto exchange rate updates and separate gain/loss tracking." },
      { type:"h2", text:"3. WhatsApp Invoice Sharing" },
      { type:"p", text:"In Pakistan, WhatsApp is how business is done. Your accounting software must be able to share invoices, payment receipts, and statements directly via WhatsApp. FinovaOS generates a PDF and a WhatsApp-ready share link in one click." },
      { type:"h2", text:"4. Urdu Support" },
      { type:"p", text:"Many business owners prefer reading figures in Urdu. FinovaOS supports bilingual invoices (English + Urdu) and an Urdu language mode for the dashboard." },
      { type:"h2", text:"5. Local Bank Reconciliation" },
      { type:"p", text:"HBL, MCB, UBL, Meezan Bank — FinovaOS supports CSV import from all major Pakistani banks for automatic bank reconciliation. No manual entry required." },
      { type:"list", items:[
        "FBR-compliant tax reports (Sales Tax, WHT, Income Tax)",
        "PKR + multi-currency with auto exchange rates",
        "WhatsApp invoice & receipt sharing",
        "Urdu language support",
        "Pakistan bank reconciliation (HBL, MCB, UBL, Meezan)",
        "EOBI & PESSI payroll deductions",
        "Local support team in Pakistan",
      ]},
      { type:"quote", text:"FinovaOS ne meri business completely transform kar di. FBR ka saara kaam ek jagah ho jaata hai — tax filing, withholding, income tax — sab kuch.", author:"Ahmed Raza, Owner — Al-Raza Traders, Karachi" },
    ],
  },
  ...
  "11": {
    ...
    content: [
      { type:"intro", text:"FBR tax compliance is the biggest pain point for Pakistani SMEs. This step-by-step guide explains every tax obligation — Sales Tax, Income Tax, and Withholding Tax — and how FinovaOS automates all of them." },
      { type:"h2", text:"Understanding Pakistan's Main Business Taxes" },
      { type:"list", items:[
        "Sales Tax (GST): 17% on goods, collected from customers and remitted monthly via IRIS",
        "Withholding Tax (WHT): Deducted on payments to suppliers — rates vary by vendor type",
        "Income Tax on Salary: Deducted from employees and deposited with FBR monthly",
      ...
      { type:"p", text:"Go to iris.fbr.gov.pk and register your business. You'll receive an NTN (National Tax Number) and STRN (Sales Tax Registration Number) if applicable. FinovaOS stores these and auto-fills them on all tax documents." },
      { type:"h2", text:"Step 2: Configure FinovaOS for FBR" },
      { type:"p", text:"In FinovaOS Settings → Tax → FBR Setup, enter your NTN, STRN, and tax period. FinovaOS will automatically tag all transactions with the correct tax codes and generate monthly returns." },
      { type:"h2", text:"Step 3: Monthly Sales Tax Return (Form ST-3)" },
      { type:"p", text:"Every month, go to Reports → Tax → Sales Tax Return in FinovaOS. The system generates a complete ST-3 form with all purchase and sales tax details. Export as XML and upload directly to IRIS." },
      { type:"h2", text:"Step 4: Withholding Tax Statements" },
      { type:"p", text:"When you pay a supplier, FinovaOS automatically calculates the applicable WHT rate based on their vendor category. Monthly WHT statements (Form 165) are generated automatically for IRIS submission." },
      { type:"h2", text:"Step 5: Annual Income Tax Return" },
      { type:"p", text:"FinovaOS generates your complete annual P&L, Balance Sheet, and Tax Computation in FBR-compatible format. Your tax consultant can file directly from FinovaOS exports." },
      { type:"quote", text:"FBR ka kaam pehle mera accountant alag se karta tha. Ab FinovaOS saara data khud generate kar deta hai — WHT, ST-3, Income Tax sab. Accountant ki fees bhi kam ho gayi.", author:"Hassan Mahmood, MD — Metro Wholesale Co., Lahore" },
    ],
  },
  ...
  "12": {
    ...
    content: [
      ...
      { type:"list", items:[
        ...
        "Purchase order to GRN workflow",
        "Sales order to delivery to invoice workflow",
        "Credit limit management per customer",
        "FBR Sales Tax and WHT compliance",
        "Multi-branch operations",
        "WhatsApp invoice sharing",
      ]},
      { type:"h2", text:"FinovaOS vs Xero" },
      { type:"p", text:"Xero is excellent for Western markets but lacks FBR compliance, Urdu support, and Pakistan-specific payroll (EOBI/PESSI). It also has no WhatsApp integration and its pricing in PKR is expensive for SMEs. FinovaOS is purpose-built for Pakistan and South Asia." },
      { type:"h2", text:"FinovaOS vs Zoho Books" },
      { type:"p", text:"Zoho Books has good multi-currency support but falls short on FBR automation, godown management, and the party ledger concept that Pakistani traders rely on. FinovaOS's trading module is specifically designed for this workflow." },
      { type:"h2", text:"FinovaOS vs Peachtree / QuickBooks Desktop" },
      { type:"p", text:"Many Pakistani businesses still use Peachtree or QuickBooks Desktop. These are powerful but require local servers, IT maintenance, no remote access, and no automatic backups. FinovaOS is cloud-based — access from your phone, from any city, with automatic daily backups." },
      { type:"h2", text:"FinovaOS vs Manual Excel / WhatsApp Ledgers" },
      { type:"p", text:"Using Excel or WhatsApp for accounts is free but costs you in errors, time, and late payments. FinovaOS customers report saving an average of 10 hours per week and collecting payments 30% faster because automated reminders go out on time." },
  ...
  "13": {
    ...
    content: [
      { type:"intro", text:"Payroll in Pakistan means managing EOBI contributions, PESSI (in Punjab), income tax deductions, and gratuity — all before you write a single payslip. FinovaOS automates all of this in one click." },
      { type:"h2", text:"Pakistan Payroll Basics" },
      { type:"list", items:[
        "EOBI: Employee 1% + Employer 5% of minimum wage (Rs. 32,000) = fixed Rs. 320 + Rs. 1,600",
        "PESSI (Punjab): Variable rate on basic salary for provincial employees",
      ...
      { type:"p", text:"Go to HR → Employees → Add Employee. Enter their basic salary, allowances (House Rent 45%, Medical 10%, Transport Rs. 5,000), CNIC, NTN (if applicable), and bank account. FinovaOS stores all this securely." },
      { type:"h2", text:"Step 2: Configure Deductions" },
      { type:"p", text:"In HR → Settings → Payroll Setup, enable EOBI, PESSI (if Punjab), income tax (auto-calculated from annual salary slab), and any other deductions like loan repayments or provident fund." },
      { type:"h2", text:"Step 3: Run Monthly Payroll" },
      { type:"p", text:"Go to HR → Payroll → Run Payroll. Select the month, verify attendance (pulled automatically from the attendance module), and click 'Process'. FinovaOS calculates every deduction and generates payslips in seconds." },
      { type:"h2", text:"Step 4: Generate Bank Transfer File" },
      { type:"p", text:"FinovaOS generates a bank payment file compatible with HBL, MCB, UBL, and Meezan Bank's bulk salary transfer format. Upload it to your bank's portal and all salaries are transferred at once — no individual transfers." },
      { type:"h2", text:"Step 5: FBR Income Tax Certificates" },
      { type:"p", text:"At year end, FinovaOS generates income tax certificates (Form 16) for all employees and the annual salary reconciliation statement for FBR submission." },
      { type:"quote", text:"12 employees ki payroll ab 10 minute mein process hoti hai. Pehle hamara accountant 2 din lagate tha sirf salary calculate karne mein. FinovaOS ne literally ek banda bachaya.", author:"Hassan Mahmood, MD — Metro Wholesale Co." },
    ],
  },
  ...
  "14": {
    ...
    content: [
      { type:"intro", text:"Pakistani pharmacies face unique inventory challenges: batch tracking, expiry date management, DRAP compliance, and controlled drug registers. FinovaOS's pharmacy inventory module handles all of these automatically." },
      { type:"h2", text:"Why Standard Inventory Software Fails Pharmacies" },
      { type:"list", items:[
        "Most software doesn't track batch numbers — DRAP requires it",
        "No expiry date alerts — expired stock sits until a customer notices",
        "No FIFO enforcement — older stock should be sold first",
        "No controlled substance register — manually maintained = errors",
        "No purchase-to-sale batch linkage — can't trace a recall",
      ]},
      { type:"h2", text:"FinovaOS Batch Tracking" },
      { type:"p", text:"When you receive stock from a supplier via a Purchase Invoice, FinovaOS requires a batch number and expiry date for each medicine. This data is stored permanently and linked to every subsequent sale — so you always know exactly which batch went to which customer." },
      { type:"h2", text:"Expiry Date Alerts" },
      { type:"p", text:"FinovaOS sends automatic alerts 90, 60, and 30 days before any batch expires. The Expiry Dashboard shows every medicine at risk of expiry sorted by urgency — so you can run promotions, return to supplier, or write off stock before it expires." },
      { type:"h2", text:"FIFO Enforcement" },
      { type:"p", text:"FinovaOS automatically enforces FIFO (First In, First Out) at the point of sale. When you sell Paracetamol 500mg, the system deducts from the oldest batch first — no manual effort required." },
      { type:"h2", text:"DRAP Compliance Reports" },
      { type:"p", text:"The Batch-wise Sales Report and Stock Movement Report give DRAP inspectors exactly what they need — a complete audit trail from purchase to patient, by batch number, with dates and quantities." },
      { type:"quote", text:"Expired stock ka pata hi nahi chalta tha pehle. Ab FinovaOS 30 din pehle alert deta hai. Last 6 months mein zero wastage — pehle Rs. 40,000 per month waste hote thay.", author:"Priya Sharma, Owner — MedPlus Pharmacy, Islamabad" },
    ],
  },
  ...
  "15": {
    ...
    content: [
      ...
      { type:"p", text:"The main concern with cloud software is internet dependency. FinovaOS handles this with offline mode — you can create invoices and record transactions without internet, and everything syncs automatically when you reconnect. For 4G Pakistan, this is rarely an issue anyway." },
      { type:"h2", text:"Data Security: Cloud vs Local" },
      { type:"p", text:"Local data feels safer but is actually more vulnerable — hard drives fail, servers get stolen, offices flood. FinovaOS stores your data in encrypted Supabase/PostgreSQL databases on AWS infrastructure with SOC 2 compliance, daily automated backups, and geo-redundancy. Your data is safer in the cloud than on a local server." },
      { type:"h2", text:"Cost Comparison (Real Numbers)" },
      { type:"list", items:[
        "Peachtree: ~Rs. 25,000 upfront + Rs. 5,000/year update + server Rs. 50,000 every 5 years = Rs. 40,000/year effective",
        "FinovaOS Starter: Rs. 2,999/month = Rs. 36,000/year — no server, no IT, mobile access included",
        "FinovaOS Professional: Rs. 7,999/month — replaces Peachtree + payroll software + inventory software",
      ]},
      { type:"quote", text:"Humara server crash ho gaya aur 6 mahine ka data gaya. Tab samjha ke cloud accounting kyun zaroori hai. Ab FinovaOS pe hain — data kabi nahi jaayega.", author:"Trader, Karachi — switched from Peachtree 2024" },
    ],
  },
};
