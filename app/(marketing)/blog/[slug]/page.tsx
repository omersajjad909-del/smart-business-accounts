...
const ALL_POSTS: Record<string, any> = {
  "bank-reconciliation-guide": {
    ...
    content: [
      { type:"intro", text:"Bank reconciliation is one of the most critical tasks in accounting. For SMEs using Finova, what used to take days now takes minutes. Here's everything you need to know about bank reconciliation — and how to automate it completely." },
      { type:"h2", text:"What is Bank Reconciliation?" },
      { type:"p", text:"Bank reconciliation is comparing your Finova ledger entries with your actual bank statement to make sure every transaction matches. Any difference — called a discrepancy — must be investigated and resolved before closing your books." },
      { type:"p", text:"Example: Finova shows a supplier payment of $500 on March 5th, but your bank statement shows $520 on March 6th. That $20 difference could be a bank charge or a timing issue — you need to find out which." },
      ...
      { type:"numbered", items:[
        "Go to Banking → Bank Reconciliation in your Finova dashboard",
      ...
      { type:"p", text:"Timing differences: A cheque you issued hasn't cleared yet. Mark it as 'outstanding' in Finova — it will clear in the next period." },
      { type:"p", text:"Duplicate entries: You accidentally entered the same transaction twice. Delete the duplicate and reconcile." },
      { type:"quote", text:"We used to spend 2 full days every month on bank reconciliation. With Finova, our accountant finishes it in 25 minutes every Monday morning.", author:"James Thompson, CEO — Thompson Trading Co." },
  ...
  "1": {
    ...
    content: [
      ...
      { type:"p", text:"From your Finova dashboard, go to Sales → Sales Invoices → New Invoice. Select your customer from the list (or add a new one), set the invoice date and due date, then add your line items." },
      ...
      { type:"p", text:"Finova supports GST, Sales Tax, and VAT configurations. Select the applicable tax from your pre-configured tax codes and Finova calculates the tax amount and grand total automatically — fully compliant with your local tax authority requirements." },
  ...
  "2": {
    ...
    content: [
      { type:"intro", text:"Finova's HR & Payroll module handles everything from employee onboarding to monthly payslips, statutory contribution calculations, and income tax withholding — all in one place. Here's how to set it up for your business." },
      { type:"h2", text:"Step 1: Add Your Employees" },
      { type:"p", text:"Go to HR → Employees → Add Employee. Fill in the employee's personal details, designation, department, date of joining, and base salary. Finova automatically calculates statutory contributions based on local regulations." },
      ...
      { type:"p", text:"Go to HR → Payroll → Run Payroll, select the month, review all calculations, and approve. Finova generates individual payslips for every employee, posts the payroll journal entry to your accounts, and marks salaries as paid." },
      { type:"list", items:[
  ...
  "3": {
    ...
    content: [
      ...
      { type:"p", text:"For each potential deal, create an Opportunity. Set the deal value, probability percentage, expected close date, and current stage (Lead → Prospect → Negotiation → Won/Lost). Finova shows your pipeline value and win probability at a glance." },
      { type:"h2", text:"Logging Interactions" },
      { type:"p", text:"Every call, meeting, email, and site visit can be logged against a contact. Set follow-up reminders. Finova's activity feed gives you a complete history of every interaction with every customer — accessible to your entire sales team." },
  ...
  "4": {
    ...
    content: [
      ...
      { type:"p", text:"Go to Inventory → Items → Add Item. For each product, set the item code, name, unit of measure, standard rate, and minimum stock level. Add a barcode for fast scanning. Finova supports thousands of SKUs with no performance issues." },
      { type:"h2", text:"Purchase Orders and GRN" },
      { type:"p", text:"Create a Purchase Order in Finova and send it to your supplier. When goods arrive, create a Purchase Invoice against the PO. Stock levels update automatically. Partially received orders are tracked — you always know what's been received and what's pending." },
  ...
  "5": {
    ...
    content: [
      ...
      { type:"p", text:"Every sales invoice in Finova tracks tax amounts by tax code. At month end, go to Reports → Tax → Sales Tax Summary. Finova generates a detailed report of all taxable sales, tax collected, and net payable — in the format required by your local tax authority." },
      { type:"h2", text:"Income Tax Withholding (Salary)" },
      { type:"p", text:"Finova's payroll module deducts income tax from employee salaries every month. At year end, generate the Annual Tax Certificates for all employees directly from HR → Reports → Tax Certificates." },
      ...
      { type:"p", text:"Finova's Balance Sheet, Profit & Loss, and Cash Flow statements are formatted for direct use in tax filing. Your tax consultant can access these reports directly — no reformatting needed." },
      { type:"list", items:[
  ...
  "6": {
    ...
    content: [
      ...
      { type:"p", text:"Every transaction in Finova — invoices, payments, vouchers, purchase orders — can be assigned to a specific branch. This means your London branch manager sees only London data, while the head office sees everything consolidated." },
      { type:"h2", text:"Consolidated Reporting" },
      { type:"p", text:"Finova's consolidated reports show you the full picture across all branches. P&L by branch, Balance Sheet consolidated, Cash Flow per location — all in one report. No more Excel merging at month end." },
      { type:"h2", text:"Cost Centers for Departments" },
      { type:"p", text:"In addition to branches, Finova supports Cost Centers — useful for tracking profitability by department (Sales, Operations, Marketing) within the same branch. Assign any transaction to a cost center for granular reporting." },
      { type:"list", items:[
      ...
      { type:"quote", text:"We have branches across Europe and one in Dubai. Before Finova, month-end consolidation took a week. Now it's instant — one click.", author:"CFO, Distribution Group" },
    ],
  },
  ...
  "7": {
    ...
    content: [
      { type:"intro", text:"Finova's quotation module lets you create professional quotes in minutes and convert them to invoices with one click — no re-entry needed. Here's how to use it to speed up your sales cycle." },
      { type:"h2", text:"Creating a Quotation" },
      { type:"p", text:"Go to Sales → Quotations → New Quotation. Select the customer, add your items with quantities and rates, apply any discount, set a validity date, and save. Finova generates a professional PDF quote ready to send." },
  ...
  "9": {
    ...
    content: [
      { type:"intro", text:"Finova generates every financial report your business needs — from daily cash position to annual tax statements. Here's a complete overview of Finova's reporting module and how each report helps you run a better business." },
      ...
      { type:"p", text:"Every Finova report can be exported as PDF, Excel, or CSV. Share with your accountant, submit to your tax authority, or attach to board meeting presentations. Reports can also be scheduled for automatic email delivery — weekly P&L to your phone every Monday morning." },
