...
export const ALL_POSTS: Record<string, BlogPost> = {
  ...
  "1": {
    ...
    excerpt: "Step-by-step guide to invoicing clients in major world currencies with automatic exchange rate updates.",
    category: "guides",
    ...
    content: [
      ...
      { type: "h2", text: "Step 1: Enable Multi-Currency in FinovaOS" },
      ...
      { type: "p", text: "For each client, set their preferred currency in their contact profile. When you create an invoice for that client, FinovaOS automatically uses their currency and applies the current exchange rate." },
  ...
  "3": {
    id: "3",
    title: "FinovaOS Q1 2025 Product Recap",
