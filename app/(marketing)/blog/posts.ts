...
export const ALL_POSTS: Record<string, BlogPost> = {
  ...
  "1": {
    ...
    content: [
      ...
      { type: "p", text: "FinovaOS fetches live exchange rates from the European Central Bank (ECB) daily. You can also manually set a rate if you've agreed a fixed rate with a client, or if you want to add a small margin." },
