...
const ARTICLES: Record<string, {
  ...
  "create-account": {
    title: "How to create your Finova account",
    category: "Getting Started", categorySlug: "getting-started",
    time: "3 min", updatedAt: "March 1, 2025",
    content: [
      { type:"intro", text:"Creating your Finova account takes less than 2 minutes. Follow these steps to get started." },
      { type:"step", step:1, text:"Go to finovaos.app and click **Get Started Now** in the top navigation bar." },
      { type:"step", step:2, text:"Choose your plan â€” Starter, Professional, or Enterprise. You can always upgrade later." },
  ...
  "choose-plan": {
    ...
    content: [
      { type:"intro", text:"Finova offers three plans to suit businesses of all sizes. Here's how to pick the one that fits you best." },
      { type:"heading", text:"Starter Plan â€” Best for small businesses" },
      { type:"list", items:["Up to 1 company", "Invoicing & billing", "Ledger & trial balance", "Basic reports", "2 users included", "Email support"] },
      { type:"heading", text:"Professional Plan â€” Best for growing teams" },
      ...
      { type:"heading", text:"Enterprise Plan â€” Best for large organizations" },
      ...
      { type:"tip", text:"Start with Starter and upgrade anytime â€” your data and settings carry over automatically. There's no lock-in." },
    ...
    related: [
      { title:"How to create your Finova account", slug:"create-account", category:"Getting Started", categorySlug:"getting-started" },
      { title:"Your first invoice â€” step by step", slug:"first-invoice", category:"Getting Started", categorySlug:"getting-started" },
    ],
  },
  ...
  "company-profile": {
    ...
    content: [
      { type:"intro", text:"Your company profile is the foundation of everything in Finova â€” it appears on invoices, reports, and all documents." },
      { type:"step", step:1, text:"Go to **Settings â†’ Company Profile** from your dashboard sidebar." },
      { type:"step", step:2, text:"Enter your **Company Name** exactly as it should appear on invoices and legal documents." },
      { type:"step", step:3, text:"Upload your **company logo** (PNG or JPG, recommended 200Ã—200px or larger)." },
  ...
  "invite-team": {
    ...
    content: [
      { type:"intro", text:"Finova supports role-based access so each team member only sees what they need to." },
      { type:"step", step:1, text:"Go to **Settings â†’ Team Members** in your dashboard." },
      ...
      { type:"list", items:["**Admin** â€” Full access to all features and settings", "**Accountant** â€” Access to reports, ledgers, and financial data", "**Sales** â€” Can create invoices and manage customers only", "**Viewer** â€” Read-only access to reports"] },
  ...
  "connect-bank": {
    ...
    content: [
      { type:"intro", text:"Connecting your bank account lets Finova import transactions automatically for faster reconciliation." },
      { type:"step", step:1, text:"Go to **Banking â†’ Bank Accounts** in your dashboard." },
      ...
      { type:"step", step:5, text:"To import transactions, go to **Bank Reconciliation â†’ Import Statement** and upload your bank's CSV/Excel export." },
      ...
      { type:"warning", text:"Finova does not store your internet banking credentials. Statements are imported as files â€” there is no direct bank sync for security reasons." },
    ],
    related: [
  ...
  "first-invoice": {
    title: "Your first invoice â€” step by step",
    category: "Getting Started", categorySlug: "getting-started",
    time: "4 min", updatedAt: "March 1, 2025",
    content: [
      { type:"intro", text:"Creating your first invoice in Finova takes under 2 minutes. Here's exactly how to do it." },
      { type:"step", step:1, text:"From your dashboard, click **Sales â†’ New Invoice** or press the **+** button in the top bar." },
      { type:"step", step:2, text:"Select or create a **customer**. Type their name and Finova will search your existing customers. If new, click 'Add Customer'." },
      { type:"step", step:3, text:"Set the **invoice date** and **due date**." },
      { type:"step", step:4, text:"Add **line items** â€” product or service name, quantity, unit price, and tax rate." },
  ...
  "create-invoice": {
    ...
    time: "3 min", updatedAt: "March 1, 2025",
    content: [
      { type:"intro", text:"Finova makes invoice creation fast and professional. Here's the full walkthrough." },
      { type:"step", step:1, text:"Navigate to **Sales â†’ Invoices â†’ New Invoice**." },
  ...
  "record-payment": {
    ...
    content: [
      { type:"intro", text:"When a customer pays an invoice, you need to record it in Finova to update your books and clear the receivable." },
      { type:"step", step:1, text:"Go to **Sales â†’ Invoices** and open the invoice you received payment for." },
      ...
      { type:"tip", text:"You can record partial payments. Finova will track the remaining balance and show the invoice as 'Partially Paid'." },
    ],
    related: [
      { title:"Creating a sales invoice", slug:"create-invoice", category:"Invoicing & Billing", categorySlug:"invoicing" },
  ...
  "bank-reconciliation": {
    ...
    content: [
      { type:"intro", text:"Bank reconciliation matches your Finova records against your actual bank statement to ensure they agree. It catches errors, missing entries, and fraud." },
      ...
      { type:"step", step:1, text:"Go to **Banking â†’ Bank Reconciliation**." },
      ...
      { type:"step", step:4, text:"Finova will show you unmatched transactions on both sides. **Tick** each transaction that appears in both your books and your statement." },
      { type:"step", step:5, text:"If a transaction is in your statement but not in Finova, click **Add Transaction** to create it." },
      { type:"step", step:6, text:"Once the **difference shows zero**, click **Complete Reconciliation**." },
      { type:"tip", text:"Reconcile monthly at minimum. Weekly reconciliation is even better for active businesses â€” it takes just a few minutes once you're in the habit." },
  ...
  "import-statements": {
    ...
    content: [
      { type:"intro", text:"Finova can import your bank statements from CSV or Excel files exported from your bank's internet banking portal." },
      { type:"step", step:1, text:"Log in to your bank's internet banking portal and download your statement as **CSV** or **Excel (.xlsx)**." },
      { type:"step", step:2, text:"In Finova, go to **Banking â†’ Bank Reconciliation â†’ Import Statement**." },
      ...
      { type:"step", step:5, text:"Finova will show a **column mapping screen**. Match the columns: Date, Description, Debit, Credit, Balance." },
      { type:"step", step:6, text:"Click **Import**. Finova will load the transactions for reconciliation." },
  ...
  "pl-statement": {
    ...
    content: [
      { type:"intro", text:"The Profit & Loss (P&L) statement â€” also called an Income Statement â€” shows how much money your business made or lost over a period." },
      { type:"heading", text:"Key sections of your P&L" },
      { type:"list", items:["**Revenue** â€” Total sales income from all invoices in the period", "**Cost of Goods Sold (COGS)** â€” Direct costs of producing what you sold", "**Gross Profit** â€” Revenue minus COGS", "**Operating Expenses** â€” Rent, salaries, utilities, and other overheads", "**Net Profit / Loss** â€” What's left after all expenses"] },
      { type:"heading", text:"How to generate your P&L in Finova" },
      { type:"step", step:1, text:"Go to **Reports â†’ Profit & Loss**." },
      ...
      { type:"tip", text:"Review your P&L at least monthly. A healthy business tracks gross margin trends â€” if your gross profit % is falling, your pricing or costs need attention." },
    ],
    related: [
  ...
  "export-reports": {
    ...
    content: [
      { type:"intro", text:"Every report in Finova can be exported to PDF or Excel with one click." },
      { type:"step", step:1, text:"Open any report from the **Reports** menu (P&L, Balance Sheet, Cash Flow, Tax Summary, etc.)." },
      { type:"step", step:2, text:"Configure the report â€” date range, comparisons, filters." },
  ...
  "add-products": {
    ...
    content: [
      { type:"intro", text:"Products and services are the items you sell. Adding them to Finova means you can add them to invoices with one click." },
      { type:"step", step:1, text:"Go to **Inventory â†’ Products & Services â†’ Add New**." },
      ...
      { type:"tip", text:"You can import products in bulk using an Excel template. Go to **Inventory â†’ Import Products** and download the template." },
    ],
    related: [
  ...
  "upgrade-plan": {
    ...
    time: "3 min", updatedAt: "March 1, 2025",
    content: [
      { type:"intro", text:"You can change your Finova plan at any time. Upgrades take effect immediately; downgrades take effect at the end of your billing cycle." },
      { type:"step", step:1, text:"Go to **Settings â†’ Subscription & Billing**." },
  ...
  "recurring-invoices": {
    ...
    content: [
      { type:"intro", text:"Recurring invoices let Finova automatically generate and send invoices on a set schedule â€” saving you hours every month." },
      ...
      { type:"step", step:1, text:"Go to **Sales â†’ Invoices â†’ New Invoice** and fill in all the invoice details as normal." },
      ...
      { type:"step", step:6, text:"Click **Save Recurring Invoice**. Finova will handle the rest." },
      { type:"tip", text:"You can pause, edit, or cancel any recurring invoice at any time from **Sales â†’ Recurring Invoices** without affecting invoices already sent." },
      { type:"warning", text:"If a recurring invoice fails to send (e.g., customer email bounces), Finova will notify you via dashboard alert. Always keep customer email addresses up to date." },
    ],
    related: [
      { title:"Creating a sales invoice", slug:"create-invoice", category:"Invoicing & Billing", categorySlug:"invoicing" },
      { title:"Recording payments & receipts", slug:"record-payment", category:"Invoicing & Billing", categorySlug:"invoicing" },
  ...
  "send-invoice": {
    ...
    content: [
      { type:"intro", text:"Finova lets you send invoices directly to customers via email or WhatsApp â€” no downloading or attaching files needed." },
      { type:"heading", text:"Send via Email" },
      { type:"step", step:1, text:"Open any finalized invoice from **Sales â†’ Invoices**." },
      { type:"step", step:2, text:"Click **Send Invoice** â†’ **Email**." },
      { type:"step", step:3, text:"Finova pre-fills the customer's email. You can edit the subject line and message body." },
      ...
      { type:"step", step:1, text:"Open the invoice and click **Send Invoice** â†’ **WhatsApp**." },
      { type:"step", step:2, text:"Finova generates a WhatsApp link with a pre-filled message and invoice PDF link." },
      { type:"step", step:3, text:"Click **Open WhatsApp** â€” it opens on your phone or WhatsApp Web with the message ready to send." },
      { type:"tip", text:"Customize your email template from **Settings â†’ Invoice Email Template** to include your brand tone, logo, and payment instructions." },
  ...
  "quotation-invoice": {
    ...
    content: [
      ...
      { type:"step", step:1, text:"Go to **Sales â†’ Quotations â†’ New Quotation**." },
      ...
      { type:"step", step:1, text:"When the customer accepts, open the quotation from **Sales â†’ Quotations**." },
  ...
  "credit-notes": {
    ...
    time: "3 min", updatedAt: "February 28, 2025",
    content: [
      { type:"intro", text:"A credit note is issued to correct or cancel a finalized invoice â€” for example, if a customer returned goods or was overcharged." },
      ...
      { type:"step", step:1, text:"Go to **Sales â†’ Invoices** and open the invoice you need to correct." },
      { type:"step", step:2, text:"Click **Issue Credit Note** at the top right." },
      { type:"step", step:3, text:"Finova pre-fills the credit note with the original invoice items. Adjust the quantities or amounts as needed." },
      { type:"step", step:4, text:"Add a **reason** for the credit note (e.g., 'Goods returned â€” damaged')." },
      ...
      { type:"warning", text:"Credit notes do not automatically refund money â€” they are accounting entries. You must separately process the cash refund through your bank if needed." },
    ],
    related: [
      { title:"Creating a sales invoice", slug:"create-invoice", category:"Invoicing & Billing", categorySlug:"invoicing" },
      { title:"Recording payments & receipts", slug:"record-payment", category:"Invoicing & Billing", categorySlug:"invoicing" },
  ...
  "match-transactions": {
    ...
    content: [
      { type:"intro", text:"Finova's auto-match engine compares your imported bank transactions against your recorded entries and suggests matches â€” reducing manual work by up to 80%." },
      { type:"heading", text:"How auto-matching works" },
      { type:"para", text:"When you import a bank statement, Finova compares each transaction's amount, date, and description against your unmatched invoices, payments, and expenses. Matches with high confidence are suggested automatically." },
      { type:"heading", text:"Reviewing and confirming matches" },
      { type:"step", step:1, text:"Go to **Banking â†’ Bank Reconciliation** and select your bank account." },
      { type:"step", step:2, text:"Click **Auto-Match**. Finova will process the statement and highlight suggested matches in green." },
      { type:"step", step:3, text:"Review each suggestion â€” confirm matches that are correct by clicking **âœ“ Accept**." },
      { type:"step", step:4, text:"For incorrect suggestions, click **âœ— Reject** and match manually." },
      { type:"step", step:5, text:"For unmatched bank transactions, click **Create Entry** to record them directly." },
      { type:"tip", text:"The more you use Finova and the more consistent your descriptions are, the better auto-matching becomes over time." },
      { type:"warning", text:"Always review auto-matches before accepting. Finova may suggest a match based on amount alone â€” verify the dates and descriptions also make sense." },
    ],
    related: [
      { title:"How bank reconciliation works", slug:"bank-reconciliation", category:"Banking & Reconciliation", categorySlug:"banking" },
      { title:"Handling unmatched transactions", slug:"unmatched-transactions", category:"Banking & Reconciliation", categorySlug:"banking" },
  ...
  "unmatched-transactions": {
    ...
    content: [
      { type:"intro", text:"Unmatched transactions are bank entries that don't correspond to any record in Finova. Clearing them is essential to complete your reconciliation." },
      { type:"heading", text:"Common reasons for unmatched transactions" },
      { type:"list", items:["Bank charges and fees not yet recorded", "Direct bank transfers not entered in Finova", "Salary payments processed outside payroll", "Bounced cheque reversals", "Interest income or penalties"] },
      ...
      { type:"warning", text:"Never just delete unmatched transactions. Always record them to the correct account â€” even if it's a minor bank fee â€” to keep your books accurate." },
    ],
    related: [
      { title:"How bank reconciliation works", slug:"bank-reconciliation", category:"Banking & Reconciliation", categorySlug:"banking" },
  ...
  "multiple-accounts": {
    ...
    content: [
      { type:"intro", text:"Finova supports unlimited bank accounts â€” you can track current accounts, savings accounts, petty cash, and foreign currency accounts all in one place." },
      { type:"step", step:1, text:"Go to **Banking â†’ Bank Accounts â†’ Add Account**." },
      ...
      { type:"step", step:5, text:"Enter the **opening balance** as of your Finova start date." },
      { type:"step", step:6, text:"Click **Save Account**. It now appears in your banking dashboard and reconciliation list." },
      { type:"tip", text:"Give each account a clear, descriptive name including the bank name. This prevents confusion when recording payments â€” especially if you have accounts at multiple banks." },
  ...
  "cpv": {
    ...
    time: "3 min", updatedAt: "February 15, 2025",
    content: [
      { type:"intro", text:"A Cash Payment Voucher (CPV) records money going out of your cash or bank account â€” for expenses, supplier payments, salaries, or any other outflow." },
      { type:"heading", text:"Creating a CPV" },
      { type:"step", step:1, text:"Go to **Banking â†’ Payment Vouchers â†’ New CPV**." },
      { type:"step", step:2, text:"Select the **payment account** (cash box or bank account the payment is made from)." },
      { type:"step", step:3, text:"Enter the **payee name** â€” supplier, employee, or vendor." },
      ...
      { type:"warning", text:"CPVs are immediately posted to the ledger when saved. If you made an error, you must create a correction entry â€” you cannot delete a posted voucher." },
    ],
    related: [
  ...
  "balance-sheet": {
    ...
    content: [
      ...
      { type:"list", items:[
        "**Current Assets** â€” Cash, receivables, inventory (convertible to cash within 1 year)",
        "**Fixed Assets** â€” Equipment, vehicles, property (long-term assets)",
        "**Current Liabilities** â€” Payables, short-term loans (due within 1 year)",
        "**Long-term Liabilities** â€” Bank loans, mortgages (due beyond 1 year)",
        "**Owner's Equity** â€” Capital invested + retained profits",
      ]},
      { type:"heading", text:"Generating your balance sheet in Finova" },
      { type:"step", step:1, text:"Go to **Reports â†’ Balance Sheet**." },
      { type:"step", step:2, text:"Select the **date** â€” the balance sheet is always as of a specific date, not a period." },
      ...
      { type:"warning", text:"If Assets â‰  Liabilities + Equity in your report, contact support immediately â€” it indicates a data entry error that needs to be traced and corrected." },
    ],
    related: [
      { title:"Understanding your P&L statement", slug:"pl-statement", category:"Reports & Analytics", categorySlug:"reports" },
      { title:"Cash flow report walkthrough", slug:"cash-flow", category:"Reports & Analytics", categorySlug:"reports" },
  ...
  "cash-flow": {
    ...
    time: "4 min", updatedAt: "March 2, 2025",
    content: [
      { type:"intro", text:"The cash flow statement shows how cash actually moved in and out of your business â€” separate from profits. A profitable business can still run out of cash without this view." },
      { type:"heading", text:"Three sections of cash flow" },
      { type:"list", items:[
        "**Operating Activities** â€” Cash from day-to-day business (invoices collected, expenses paid)",
        "**Investing Activities** â€” Cash spent on or received from assets (equipment purchase, asset sales)",
        "**Financing Activities** â€” Cash from loans, repayments, or owner withdrawals",
      ]},
      { type:"heading", text:"Generating the cash flow report" },
      { type:"step", step:1, text:"Go to **Reports â†’ Cash Flow Statement**." },
      ...
      { type:"tip", text:"Watch your **Net Change in Cash** line every month. If it's consistently negative while you're profitable, you likely have a receivables collection problem â€” customers are paying too slowly." },
  ...
  "tax-summary": {
    ...
    content: [
      { type:"intro", text:"Finova's tax summary report consolidates all your taxable transactions in one place â€” making it easy to file GST, sales tax, or income tax returns." },
      ...
      { type:"step", step:1, text:"Go to **Reports â†’ Tax Summary**." },
      ...
      { type:"para", text:"Use the exported tax summary as a reference when logging into your country's tax portal. The figures in Finova match what you need to enter." },
      { type:"tip", text:"Set up tax rates correctly in **Settings â†’ Tax Rates** before creating invoices. This ensures every invoice automatically applies the right tax and appears correctly in the summary." },
      { type:"warning", text:"Finova generates reports based on the data you enter. If invoices are missing or tax rates were set up incorrectly, the tax summary will be wrong. Review your setup with an accountant before your first filing." },
    ],
    related: [
      { title:"Understanding your P&L statement", slug:"pl-statement", category:"Reports & Analytics", categorySlug:"reports" },
      { title:"Exporting reports to PDF & Excel", slug:"export-reports", category:"Reports & Analytics", categorySlug:"reports" },
  ...
  "scheduled-reports": {
    ...
    time: "3 min", updatedAt: "February 18, 2025",
    content: [
      { type:"intro", text:"Finova can automatically generate and email reports on a schedule â€” so you and your team always have up-to-date financials without manual effort." },
      { type:"step", step:1, text:"Go to **Reports â†’ Scheduled Reports â†’ New Schedule**." },
      ...
      { type:"step", step:5, text:"Enter the **recipient email addresses** â€” you can send to multiple people." },
      { type:"step", step:6, text:"Choose the **format**: PDF, Excel, or both." },
      { type:"step", step:7, text:"Click **Save Schedule**. Finova will send the report automatically going forward." },
      { type:"tip", text:"Set up a monthly P&L report to your email so you always review business performance at the start of each month â€” even when you're busy." },
    ],
    related: [
      { title:"Exporting reports to PDF & Excel", slug:"export-reports", category:"Reports & Analytics", categorySlug:"reports" },
      { title:"Understanding your P&L statement", slug:"pl-statement", category:"Reports & Analytics", categorySlug:"reports" },
  ...
  "stock-alerts": {
    ...
    content: [
      { type:"intro", text:"Stock alerts notify you when a product falls below its reorder level â€” preventing stockouts before they happen." },
      { type:"step", step:1, text:"Go to **Inventory â†’ Products** and open any product." },
      { type:"step", step:2, text:"Find the **Reorder Level** field and enter the minimum quantity you want to keep in stock." },
      { type:"step", step:3, text:"Optionally set a **Reorder Quantity** â€” how much to order when restocking." },
      { type:"step", step:4, text:"Click **Save**." },
      { type:"heading", text:"Viewing stock alerts" },
      { type:"para", text:"When any product falls at or below its reorder level, it appears in the **Inventory â†’ Low Stock Alerts** dashboard. You'll also see a notification badge in the main menu." },
  ...
  "stock-entries": {
    ...
    time: "3 min", updatedAt: "March 1, 2025",
    content: [
      { type:"intro", text:"Stock entries record physical movement of goods â€” purchases (stock in) and adjustments or write-offs (stock out) â€” keeping your inventory count accurate." },
      { type:"heading", text:"Stock In (Goods Received)" },
      { type:"step", step:1, text:"Go to **Inventory â†’ Stock Entries â†’ New Stock In**." },
      ...
      { type:"step", step:1, text:"Go to **Inventory â†’ Stock Entries â†’ New Stock Out**." },
  ...
  "inventory-valuation": {
    ...
    content: [
      ...
      { type:"heading", text:"FIFO â€” First In, First Out" },
      ...
      { type:"heading", text:"LIFO â€” Last In, First Out" },
      ...
      { type:"step", step:1, text:"Go to **Settings â†’ Inventory Settings**." },
  ...
  "stock-transfer": {
    ...
    content: [
      { type:"intro", text:"If your business has multiple branches or warehouses, Finova lets you transfer stock between them while keeping each location's inventory accurate." },
      { type:"step", step:1, text:"Go to **Inventory â†’ Stock Transfers â†’ New Transfer**." },
      ...
      { type:"warning", text:"Stock transfers on the Enterprise plan support approval workflows â€” a branch manager must approve incoming stock before it's added to their count. Enable this in **Settings â†’ Inventory â†’ Require Transfer Approval**." },
    ],
    related: [
      { title:"Adding products and services", slug:"add-products", category:"Inventory & Stock", categorySlug:"inventory" },
      { title:"Stock in / stock out entries", slug:"stock-entries", category:"Inventory & Stock", categorySlug:"inventory" },
  ...
  "stock-reports": {
    ...
    time: "2 min", updatedAt: "February 10, 2025",
    content: [
      { type:"intro", text:"Finova's inventory reports give you a real-time view of stock levels, movement, and valuation across all locations." },
      { type:"heading", text:"Available stock reports" },
      { type:"list", items:[
        "**Stock Summary** â€” Current quantity and value of all products",
        "**Stock Movement Report** â€” History of all stock in/out for a period",
        "**Low Stock Report** â€” All products at or below reorder level",
        "**Stock Valuation Report** â€” Total inventory value by product",
        "**Branch-wise Stock** â€” Quantities per location (Enterprise plan)",
      ]},
      { type:"heading", text:"Running a report" },
      { type:"step", step:1, text:"Go to **Reports â†’ Inventory Reports** and select the report type." },
      ...
      { type:"tip", text:"Run the Stock Valuation Report at month-end and compare it to your balance sheet's inventory asset value. They should match â€” any difference needs investigation." },
    ],
    related: [
      { title:"Adding products and services", slug:"add-products", category:"Inventory & Stock", categorySlug:"inventory" },
      { title:"Inventory valuation methods (FIFO/LIFO)", slug:"inventory-valuation", category:"Inventory & Stock", categorySlug:"inventory" },
  ...
  "download-invoices": {
    title: "Downloading your Finova invoices and receipts",
    category: "Account & Billing", categorySlug: "account",
    time: "2 min", updatedAt: "February 15, 2025",
    content: [
      { type:"intro", text:"All your Finova subscription invoices and payment receipts are available to download from your account at any time." },
      { type:"step", step:1, text:"Go to **Settings â†’ Subscription & Billing â†’ Billing History**." },
      ...
      { type:"para", text:"To update the name, address, or tax number shown on your Finova invoices, go to **Settings â†’ Billing Profile** and update your details. Future invoices will reflect the changes." },
    ],
    related: [
  ...
  "cancel-subscription": {
    ...
    time: "3 min", updatedAt: "March 1, 2025",
    content: [
      { type:"intro", text:"You can cancel your Finova subscription at any time. Your account remains active until the end of your current billing period." },
      { type:"step", step:1, text:"Go to **Settings â†’ Subscription & Billing**." },
      ...
      { type:"tip", text:"Before cancelling, export your data from **Settings â†’ Data Export**. This gives you a full backup of all invoices, accounts, and transactions." },
  ...
  "data-export": {
    ...
    content: [
      { type:"intro", text:"Finova lets you export all your business data at any time â€” invoices, transactions, contacts, reports, and more â€” in standard formats you can keep forever." },
      ...
      { type:"step", step:1, text:"Go to **Settings â†’ Data Export**." },
      ...
      { type:"tip", text:"Schedule a monthly data export as a backup habit â€” it only takes 30 seconds and gives you peace of mind. Store the ZIP files in Google Drive or Dropbox." },
      { type:"warning", text:"Data exports are sent to your account's registered email only, for security. Make sure your email address is current in **Settings â†’ Account**." },
    ],
    related: [
      { title:"Cancelling your subscription", slug:"cancel-subscription", category:"Account & Billing", categorySlug:"account" },
  ...
  "delete-account": {
    ...
    content: [
      ...
      { type:"warning", text:"Account deletion cannot be undone. All your data â€” invoices, transactions, reports, contacts â€” will be permanently erased. There is no recovery after deletion." },
      { type:"heading", text:"Before you delete" },
      { type:"list", items:[
        "Export all your data from Settings â†’ Data Export",
        "Download all invoices you may need for tax purposes",
        "Cancel any active subscription first",
        "Inform your team members â€” their access will also end",
      ]},
      { type:"heading", text:"How to delete your account" },
      { type:"step", step:1, text:"Go to **Settings â†’ Account â†’ Danger Zone**." },
      ...
      { type:"tip", text:"Consider downgrading to our free tier instead of deleting â€” you keep access to view your historical data without paying anything." },
    ],
    related: [
      { title:"Data export and backup", slug:"data-export", category:"Account & Billing", categorySlug:"account" },
      { title:"Cancelling your subscription", slug:"cancel-subscription", category:"Account & Billing", categorySlug:"account" },
...
/* â”€â”€â”€ Bold text renderer â”€â”€â”€ */
          ...
          case "warning":
            return (
              <div key={i} style={{ padding:"14px 16px", borderRadius:12, background:"rgba(251,191,36,.06)", border:"1.5px solid rgba(251,191,36,.22)", display:"flex", gap:12, alignItems:"flex-start" }}>
                <span style={{ fontSize:16, flexShrink:0, marginTop:1 }}>âš ï¸</span>
                <p style={{ fontSize:13.5, color:"rgba(255,255,255,.6)", lineHeight:1.75, margin:0 }}>
    ...
    return (
      <div style={{ minHeight:"100vh", background:"#080c1e", display:"flex", alignItems:"center", justifyContent:"center", color:"white", fontFamily:"'Outfit',sans-serif" }}>
        <div style={{ textAlign:"center" }}>
          ...
          <Link href="/help" style={{ color:"#818cf8", fontWeight:600, fontSize:14 }}>â† Back to Help Center</Link>
        </div>
      </div>
    );
  }
...
/* â”€â”€â”€ Client component for helpful widget â”€â”€â”€ */
  ...
  return (
    <div style={{ borderRadius:16, padding:"20px 22px", background:"rgba(255,255,255,.03)", border:"1px solid rgba(255,255,255,.07)", marginBottom:32, display:"flex", alignItems:"center", justifyContent:"space-between", flexWrap:"wrap", gap:14 }}>
      ...
      <div style={{ display:"flex", gap:8 }}>
        <a href="?helpful=yes" style={{ padding:"8px 18px", borderRadius:10, background:"rgba(52,211,153,.08)", border:"1.5px solid rgba(52,211,153,.25)", color:"#34d399", fontSize:13, fontWeight:600, textDecoration:"none" }}>ðŸ‘ Yes</a>
        <a href="?helpful=no"  style={{ padding:"8px 18px", borderRadius:10, background:"rgba(248,113,113,.08)", border:"1.5px solid rgba(248,113,113,.2)",  color:"#f87171", fontSize:13, fontWeight:600, textDecoration:"none" }}>ðŸ‘Ž No</a>
      </div>
    </div>
  );
}
