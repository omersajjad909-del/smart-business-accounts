...
const ARTICLES: Record<string, {
  ...
  "company-profile": {
    ...
    content: [
      { type:"intro", text:"Your company profile is the foundation of everything in Finova — it appears on invoices, reports, and all documents." },
  ...
  "connect-bank": {
    ...
    content: [
      ...
      { type:"warning", text:"Finova does not store your internet banking credentials. Statements are imported as files — there is no direct bank sync for security reasons." },
    ],
    related: [
  ...
  "import-statements": {
    ...
    content: [
      ...
      { type:"step", step:2, text:"In Finova, go to **Banking → Bank Reconciliation → Import Statement**." },
  ...
  "recurring-invoices": {
    ...
    content: [
      { type:"intro", text:"Recurring invoices let Finova automatically generate and send invoices on a set schedule — saving you hours every month." },
  ...
  "send-invoice": {
    ...
    content: [
      { type:"intro", text:"Finova lets you send invoices directly to customers via email or WhatsApp — no downloading or attaching files needed." },
  ...
  "match-transactions": {
    ...
    content: [
      { type:"intro", text:"Finova's auto-match engine compares your imported bank transactions against your recorded entries and suggests matches — reducing manual work by up to 80%." },
      ...
      { type:"warning", text:"Always review auto-matches before accepting. Finova may suggest a match based on amount alone — verify the dates and descriptions also make sense." },
    ],
    related: [
      { title:"How bank reconciliation works", slug:"bank-reconciliation", category:"Banking & Reconciliation", categorySlug:"banking" },
      { title:"Handling unmatched transactions", slug:"unmatched-transactions", category:"Banking & Reconciliation", categorySlug:"banking" },
  ...
  "multiple-accounts": {
    ...
    content: [
      { type:"intro", text:"Finova supports unlimited bank accounts — you can track current accounts, savings accounts, petty cash, and foreign currency accounts all in one place." },
  ...
  "tax-summary": {
    ...
    content: [
      { type:"intro", text:"Finova's tax summary report consolidates all your taxable transactions in one place — making it easy to file GST, sales tax, or income tax returns." },
  ...
  "scheduled-reports": {
    ...
    time: "3 min", updatedAt: "February 18, 2025",
    content: [
      { type:"intro", text:"Finova can automatically generate and email reports on a schedule — so you and your team always have up-to-date financials without manual effort." },
  ...
  "download-invoices": {
    ...
    content: [
      ...
      { type:"para", text:"To update the name, address, or tax number shown on your Finova invoices, go to **Settings → Billing Profile** and update your details. Future invoices will reflect the changes." },
    ],
    related: [
  ...
  "data-export": {
    ...
    content: [
      { type:"intro", text:"Finova lets you export all your business data at any time — invoices, transactions, contacts, reports, and more — in standard formats you can keep forever." },
