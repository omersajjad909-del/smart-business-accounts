...
function LoadingShell() {
  return (
    <div style={{
      minHeight: "100vh", background: "linear-gradient(160deg,var(--dk-040616, #040616),var(--dk-0a0d24, #0a0d24))",
      color: "var(--ink-solid, white)", fontFamily: FONT, display: "flex", alignItems: "center",
      justifyContent: "center", padding: 24,
    }}>
      <div style={{ fontSize: 13, color: "rgba(var(--ink),var(--ta-50, .5))" }}>Loading…</div>
    </div>
  );
}
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        borderRadius: 24, background: "rgba(var(--ink),.03)",
        ...
        {status === "loading" && (
          <>
            ...
            <div style={{ fontSize: 13, color: "rgba(var(--ink),var(--ta-50, .5))", lineHeight: 1.6 }}>
        ...
        {status === "waiting" && (
          <>
            ...
            <div style={{ fontSize: 13, color: "rgba(var(--ink),var(--ta-50, .5))", lineHeight: 1.6, marginBottom: 20 }}>
            ...
            {waitSeconds != null && waitSeconds > 0 && (
              <div style={{ padding: "12px 20px", borderRadius: 12, background: "rgba(99,102,241,.1)", border: "1px solid rgba(99,102,241,.25)", display: "inline-block", fontSize: 15, fontWeight: 800, color: "var(--tx-a5b4fc, #a5b4fc)" }}>
                Starts in {Math.floor(waitSeconds / 60)}m {waitSeconds % 60}s
              </div>
            )}
            <div style={{ fontSize: 12, color: "rgba(var(--ink),var(--ta-35, .35))", marginTop: 18 }}>
        ...
        {status === "ok" && (
          <>
            ...
            <div style={{ fontSize: 13, color: "rgba(var(--ink),var(--ta-50, .5))" }}>
        ...
        {status === "error" && (
          <>
            ...
            <a href="/demo" style={{
              ...
              color: "var(--ink-solid, white)", textDecoration: "none", fontSize: 13, fontWeight: 700,
            }}>
              ← Back to demos
            </a>
          </>
