...
const PLAN_ROWS: Record<string, { feature:string; starter:string|boolean; pro:string|boolean; enterprise:string|boolean }[]> = {
  trading: [
    ...
    { feature:"Purchase orders & GRN",       starter:"Basic",   pro:true,          enterprise:true },
    { feature:"Stock ledger & costing",      starter:"Basic",   pro:"FIFO / Avg",  enterprise:"FIFO / Avg" },
    { feature:"Party ledger & ageing",       starter:true,      pro:true,          enterprise:true },
    { feature:"Multi-godown stock",          starter:false,     pro:"Up to 3",     enterprise:"Up to 10" },
    { feature:"Bank reconciliation",         starter:false,     pro:true,          enterprise:true },
    { feature:"Profit by item / party",      starter:"Basic",   pro:"Advanced",    enterprise:"Full suite" },
    { feature:"Team members",                starter:"1",       pro:"Up to 3",     enterprise:"Up to 10" },
  ],
  distribution: [
    { feature:"Sales & purchase invoicing",  starter:true,      pro:true,          enterprise:true },
    { feature:"Multi-depot inventory",       starter:false,     pro:"Up to 3",     enterprise:"Up to 10" },
    { feature:"Route & van load-out",        starter:"Basic",   pro:true,          enterprise:true },
    { feature:"Daily route settlement",      starter:false,     pro:true,          enterprise:true },
    { feature:"Retailer credit limits",      starter:"Basic",   pro:true,          enterprise:true },
    { feature:"Schemes & trade discounts",   starter:false,     pro:true,          enterprise:true },
    { feature:"Salesman commission",         starter:false,     pro:true,          enterprise:true },
    { feature:"Route & depot P&L",           starter:"Basic",   pro:"Advanced",    enterprise:"Full suite" },
  ],
  wholesale: [
    { feature:"Bulk order to invoice",       starter:true,      pro:true,          enterprise:true },
    { feature:"Slab & tier pricing",         starter:"Basic",   pro:true,          enterprise:true },
    { feature:"Dealer ledger & statements",  starter:true,      pro:true,          enterprise:true },
    { feature:"Credit limit enforcement",    starter:"Warn",    pro:"Warn / Block",enterprise:"Warn / Block" },
    { feature:"Returns, claims & notes",     starter:true,      pro:true,          enterprise:true },
    { feature:"Multi-warehouse stock",       starter:false,     pro:"Up to 3",     enterprise:"Up to 10" },
    { feature:"Ageing & recovery reports",   starter:"Basic",   pro:"Advanced",    enterprise:"Full suite" },
    { feature:"Dealer-wise profitability",   starter:false,     pro:true,          enterprise:true },
  ],
  retail: [
    { feature:"POS billing & barcode",       starter:true,      pro:true,          enterprise:true },
    { feature:"Shift & cash close",          starter:true,      pro:true,          enterprise:true },
    { feature:"Inventory & reorder alerts",  starter:"Basic",   pro:true,          enterprise:true },
    { feature:"Multi-store & transfers",     starter:false,     pro:"Up to 3",     enterprise:"Up to 10" },
    { feature:"Loyalty & customer history",  starter:false,     pro:true,          enterprise:true },
    { feature:"Staff shifts & commission",   starter:false,     pro:true,          enterprise:true },
    { feature:"Store-wise P&L",              starter:"Basic",   pro:"Advanced",    enterprise:"Full suite" },
    { feature:"Team members",                starter:"1",       pro:"Up to 3",     enterprise:"Up to 10" },
  ],
  import_company: [
    { feature:"Shipment / consignment files",starter:true,      pro:true,          enterprise:true },
    { feature:"Landed cost apportionment",   starter:"Basic",   pro:true,          enterprise:true },
    { feature:"LC & TT tracking",            starter:false,     pro:true,          enterprise:true },
    { feature:"Goods in transit",            starter:false,     pro:true,          enterprise:true },
    { feature:"Multi-currency & FX posting", starter:false,     pro:true,          enterprise:true },
    { feature:"Export invoice & packing list",starter:"Basic",  pro:true,          enterprise:true },
    { feature:"Shipment-wise profit",        starter:"Basic",   pro:"Advanced",    enterprise:"Full suite" },
    { feature:"Team members",                starter:"1",       pro:"Up to 3",     enterprise:"Up to 10" },
  ],
  clearing_forwarding: [
    { feature:"Job file per consignment",    starter:true,      pro:true,          enterprise:true },
    { feature:"Reimbursable vs agency fee",  starter:true,      pro:true,          enterprise:true },
    { feature:"Duty & port charge log",      starter:"Basic",   pro:true,          enterprise:true },
    { feature:"Document set checklist",      starter:"Basic",   pro:true,          enterprise:true },
    { feature:"Demurrage & detention",       starter:false,     pro:true,          enterprise:true },
    { feature:"Client statements",           starter:true,      pro:true,          enterprise:true },
    { feature:"Job-wise & client P&L",       starter:"Basic",   pro:"Advanced",    enterprise:"Full suite" },
    { feature:"Team members",                starter:"1",       pro:"Up to 3",     enterprise:"Up to 10" },
  ],
  manufacturing: [
    { feature:"Bill of materials (BOM)",     starter:"Basic",   pro:true,          enterprise:true },
    { feature:"Production orders",           starter:"Basic",   pro:true,          enterprise:true },
    { feature:"Raw material & store control",starter:true,      pro:true,          enterprise:true },
    { feature:"Work-in-progress valuation",  starter:false,     pro:true,          enterprise:true },
    { feature:"Labour & overhead costing",   starter:false,     pro:true,          enterprise:true },
    { feature:"Scrap, rework & wastage",     starter:false,     pro:true,          enterprise:true },
    { feature:"Batch & lot traceability",    starter:false,     pro:true,          enterprise:true },
    { feature:"Product profitability",       starter:"Basic",   pro:"Advanced",    enterprise:"Full suite" },
  ],
  travel: [
  ...
  Commerce: [
    ...
    { feature:"Party ledger & ageing",       starter:true,      pro:true,          enterprise:true },
    { feature:"Bank reconciliation",         starter:false,     pro:true,          enterprise:true },
    { feature:"Multi-branch operations",     starter:false,     pro:"Up to 3",     enterprise:"Up to 10" },
  ...
  Healthcare: [
    ...
    { feature:"Multi-branch / chain",        starter:false,     pro:"Up to 3",     enterprise:"Up to 10" },
    { feature:"Revenue analytics",           starter:"Basic",   pro:"Advanced",    enterprise:"Full suite" },
  ],
  Education: [
    ...
    { feature:"Multi-campus",                starter:false,     pro:"Up to 3",     enterprise:"Up to 10" },
  ...
  Hospitality: [
    ...
    { feature:"Multi-outlet",                starter:false,     pro:"Up to 3",     enterprise:"Up to 10" },
  ...
  Production: [
    ...
    { feature:"Multi-factory / branch",      starter:false,     pro:"Up to 3",     enterprise:"Up to 10" },
  ...
  Logistics: [
    ...
    { feature:"Multi-depot / branch",        starter:false,     pro:"Up to 3",     enterprise:"Up to 10" },
  ...
  "Food & Beverage": [
    ...
    { feature:"Multi-outlet / branch",       starter:false,     pro:"Up to 3",     enterprise:"Up to 10" },
    { feature:"Daily sales reports",         starter:"Basic",   pro:"Advanced",    enterprise:"Full suite" },
  ...
  Construction: [
    ...
    { feature:"Multi-site operations",       starter:false,     pro:"Up to 5",     enterprise:"Up to 10" },
  ...
  "Real Estate": [
    ...
    { feature:"Multi-property portfolio",    starter:false,     pro:"Up to 10",    enterprise:"Up to 10" },
  ...
  Agriculture: [
    ...
    { feature:"Multi-farm / land parcels",   starter:false,     pro:"Up to 5",     enterprise:"Up to 10" },
  ...
  Automotive: [
    ...
    { feature:"Multi-branch showroom",       starter:false,     pro:"Up to 3",     enterprise:"Up to 10" },
  ],
  "Media & Advertising": [
    ...
    { feature:"Multi-team / department",     starter:false,     pro:"Up to 3",     enterprise:"Up to 10" },
  ],
  "Beauty & Wellness": [
    ...
    { feature:"Multi-branch management",     starter:false,     pro:"Up to 3",     enterprise:"Up to 10" },
  ],
  Repair: [
    ...
    { feature:"Multi-branch workshop",       starter:false,     pro:"Up to 3",     enterprise:"Up to 10" },
