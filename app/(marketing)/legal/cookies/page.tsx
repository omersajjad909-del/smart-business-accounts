...
export default function CookiePolicyPage() {
  return (
    <main
      style={{
        minHeight: "100vh",
        background: "linear-gradient(180deg,var(--dk-070a1d, #070a1d) 0%,var(--dk-0a1029, #0a1029) 45%,var(--dk-070a1d, #070a1d) 100%)",
    ...
    >
      ...
      <section style={{ maxWidth: 980, margin: "0 auto", padding: "108px 24px 84px" }}>
        <div style={{ maxWidth: 760, marginBottom: 34 }}>
          ...
          <p style={{ margin: "0 0 10px", fontSize: 16.5, color: "rgba(var(--ink),var(--ta-56, .56))", lineHeight: 1.85 }}>
          ...
          <div style={{ fontSize: 12.5, color: "rgba(var(--ink),var(--ta-34, .34))" }}>Last updated: {LAST_UPDATED}</div>
        </div>
        ...
        <div style={{ display: "grid", gap: 16 }}>
          {SECTIONS.map((section) => (
            ...
            >
              <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 12 }}>
                <div
                  style={{
                    ...
                    height: 42,
                    borderRadius: 14,
                    background: `color-mix(in srgb, ${section.color} 9.4%, transparent)`,
                    border: `1px solid color-mix(in srgb, ${section.color} 18.4%, transparent)`,
                    display: "flex",
                    alignItems: "center",
              ...
              <p style={{ margin: 0, fontSize: 14.5, lineHeight: 1.85, color: "rgba(var(--ink),var(--ta-66, .66))" }}>{section.body}</p>
            </article>
          ))}
        </div>
        ...
        >
          ...
          <p style={{ margin: "0 0 12px", color: "rgba(var(--ink),var(--ta-58, .58))", lineHeight: 1.75, fontSize: 14 }}>
          ...
          <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
            ...
            <Link href="/legal/privacy" style={{ textDecoration: "none", color: "var(--tx-c4b5fd, #c4b5fd)", border: "1px solid rgba(196,181,253,.25)", background: "rgba(var(--ink),.03)", padding: "11px 18px", borderRadius: 12, fontSize: 13, fontWeight: 800 }}>
              View Privacy Policy
            </Link>
          </div>
        </div>
