    ...
    <div style={{ minHeight: "100vh", background: "linear-gradient(160deg,var(--dk-04061a, #04061a) 0%,var(--dk-080c2a, #080c2a) 60%,var(--dk-04061a, #04061a) 100%)", fontFamily: "'Outfit','Inter',sans-serif", color: "var(--tx-e2e8f0, #e2e8f0)" }}>
      ...
      <div style={{ maxWidth: 820, margin: "0 auto", padding: "48px 24px 100px" }}>
        <div style={{ textAlign: "center", marginBottom: 48 }}>
          <div style={{ display: "inline-block", background: "rgba(52,211,153,.12)", border: "1px solid rgba(52,211,153,.3)", color: "var(--tx-34d399, #34d399)", padding: "5px 16px", borderRadius: 20, fontSize: 13, fontWeight: 600, marginBottom: 16 }}>
            Legal
          </div>
        ...
        <div style={{ background: "rgba(52,211,153,.06)", border: "1px solid rgba(52,211,153,.2)", borderRadius: 14, padding: "16px 20px", marginBottom: 40, fontSize: 14, color: "var(--tx-94a3b8, #94a3b8)", lineHeight: 1.7 }}>
        ...
        <p style={{ marginTop: 24, textAlign: "center", fontSize: 13, color: "#475569" }}>
          Questions about this SLA? Email us at <a href="mailto:legal@finovaos.app" style={{ color: "var(--tx-818cf8, #818cf8)" }}>legal@finovaos.app</a>
        </p>
      </div>
    </div>
  );
