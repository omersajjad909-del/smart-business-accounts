...
export const metadata: Metadata = {
  ...
  description:
    "FinovaOS's Terms of Service govern your use of our cloud accounting and business management platform. Read our terms, your rights, and our obligations. Last updated March 1, 2025.",
  openGraph: {
