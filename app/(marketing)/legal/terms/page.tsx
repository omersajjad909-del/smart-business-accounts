...
const SECTIONS = [
    ...
    content: [
      {
        ...
        body: "FinovaOS is a cloud-based business software platform that provides accounting, financial management, inventory, payroll, reporting, and operational tools. FinovaOS is software only and does not provide financial, legal, or tax advice of any kind.",
      },
    ],
  },
  {
    ...
    content: [
      {
        sub: "Customer Responsibility",
        body: "FinovaOS provides accounting, operational, and analytical tools designed to assist businesses in managing their finances and operations. Customers remain fully responsible for reviewing, validating, and approving all financial records, tax filings, reports, and compliance obligations before submission or business use. FinovaOS does not audit your records, verify the accuracy of data entered, or guarantee the correctness of any output generated from customer-provided data.",
      },
      {
        sub: "Not Professional Advice",
        body: "FinovaOS is software, not a financial advisor, tax consultant, auditor, or legal professional. Reports, calculations, and outputs generated by the platform are tools to assist your team — not substitutes for professional financial or legal advice. Always consult a qualified accountant, tax professional, or legal advisor before making compliance, filing, or business decisions.",
      },
      {
        sub: "Data Entry Accuracy",
        body: "The accuracy of all financial statements, tax reports, inventory valuations, payroll calculations, and other outputs depends entirely on the accuracy and completeness of data entered by your users. FinovaOS is not liable for errors, misstatements, or compliance failures arising from incorrect, incomplete, or fraudulent data entry by any member of your team.",
      },
    ],
  },
  {
    ...
    title: "AI & Automated Outputs",
    content: [
      {
        sub: "Informational Purposes Only",
        body: "AI-generated insights, forecasts, recommendations, automation suggestions, and analytical outputs provided by FinovaOS are for informational and operational assistance purposes only. They do not constitute financial, legal, tax, investment, or business advice of any kind and should not be relied upon as such.",
      },
      {
        sub: "No Training on Customer Data",
        body: "Your business data is never used to train public or shared AI models. All AI-powered features in FinovaOS operate exclusively within your isolated workspace environment using your own data only.",
      },
      {
        sub: "Human Review Required",
        body: "Customers are responsible for reviewing all AI-generated outputs before acting on them. FinovaOS shall not be liable for any business decisions, financial actions, tax filings, or operational changes made based on AI-generated content. Final judgment and accountability for all decisions rest solely with the customer at all times.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        body: "Your data may be stored on secure cloud servers located in different countries. Payments are processed by LemonSqueezy, a trusted third-party payment provider. We do not store your full card details.",
      },
    ],
  },
  {
    ...
    content: [
      {
        sub: "Data Protection",
        body: "All data is encrypted in transit using TLS 1.3 and at rest using AES-256. We use enterprise-grade cloud infrastructure, automated daily backups, and role-based access controls to protect your data. No system is 100% secure — you acknowledge that you use the platform at your own risk.",
      },
    ],
  },
  {
    ...
    dim: "rgba(var(--txr-06b6d4, 6,182,212),.08)",
    border: "rgba(6,182,212,.25)",
    title: "Service Availability & Downtime",
    content: [
      {
        sub: "No Uptime Guarantee",
        body: "FinovaOS does not guarantee uninterrupted, error-free, or continuously available access to the platform. While we strive to maintain high availability, we cannot warrant that the service will be accessible at all times or free from bugs, errors, or security vulnerabilities.",
      },
      {
        sub: "Scheduled & Emergency Maintenance",
        body: "We may perform scheduled maintenance, software upgrades, infrastructure migrations, or emergency service interruptions when necessary. We will make reasonable efforts to notify users in advance of planned maintenance. Emergency situations may not allow for prior notice.",
      },
      {
        sub: "No Liability for Downtime",
        body: "FinovaOS shall not be liable for any losses, damages, missed filings, or business disruptions resulting from platform unavailability, planned or unplanned service interruptions, or performance degradation. Customers are advised to maintain offline copies of critical business records, especially around statutory filing deadlines.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    content: [
      {
        sub: "General Prohibited Activities",
        body: "You agree NOT to use FinovaOS for: fraud, money laundering, financing of illegal activities, hacking or unauthorized access to any system, uploading malicious or illegal content, attempting to reverse-engineer or copy the software, or reselling platform access without a formal written partnership agreement from Finova Forge.",
      },
      {
        sub: "Financial Fraud & Fake Invoicing",
        body: "You may not use FinovaOS to generate fraudulent invoices, create fictitious financial records, inflate or deflate financial statements for tax evasion, misrepresent inventory valuations, or otherwise use the platform to facilitate any form of financial fraud, tax fraud, or regulatory deception. Accounts found engaging in such activities will be suspended immediately without refund and may be reported to relevant regulatory or law enforcement authorities.",
      },
      {
        sub: "Automated Abuse & Spam",
        body: "You may not use automated scripts, bots, crawlers, or programmatic tools to extract bulk data beyond permitted API usage, overload platform infrastructure, create fake accounts at scale, send unsolicited communications through the system, or perform any action inconsistent with normal authorized use of the platform.",
      },
      {
        sub: "Account Sharing",
        body: "Subscription accounts are for the registered customer organization only. Sharing login credentials across unregistered businesses or using a single subscription to serve multiple unaffiliated companies is prohibited. Each organization that uses FinovaOS must hold its own active subscription.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    dim: "rgba(var(--txr-06b6d4, 6,182,212),.08)",
    border: "rgba(6,182,212,.25)",
    title: "Data Backup & Retention Responsibility",
    content: [
      {
        sub: "Infrastructure Backups",
        body: "FinovaOS performs automated daily backups of all customer data on enterprise-grade cloud infrastructure. Backup snapshots are retained for up to 30 days and are subject to the same security controls and deletion schedule as live data. Infrastructure backups are intended for disaster recovery and do not extend your data retention window after account cancellation.",
      },
      {
        sub: "Customer Responsibility",
        body: "Customers are strongly encouraged to maintain independent backups of critical business records including financial statements, invoices, inventory records, payroll data, and tax documents. While FinovaOS performs infrastructure-level backups, customers remain solely responsible for their own operational data retention obligations, regulatory archiving requirements, and compliance with applicable tax and accounting laws in their jurisdiction.",
      },
      {
        sub: "Export Anytime",
        body: "You may export your data at any time using the built-in export tools. FinovaOS supports data export in standard formats including CSV, Excel, and PDF. We strongly recommend performing regular exports as part of your organization's own data management and business continuity practices.",
      },
    ],
  },
  {
    ...
    content: [
      {
        ...
        body: "In the event of any dispute, claim, or controversy arising from or related to these Terms or your use of FinovaOS, both parties agree to first attempt informal resolution by contacting us in writing at legal@finovaos.app. We will make a good-faith effort to resolve the matter within 30 days of receiving written notice.",
      },
      {
        sub: "Binding Arbitration",
        body: "If informal resolution fails, disputes may be escalated to binding arbitration under internationally recognized arbitration rules applicable to the jurisdiction in which Finova Forge operates. The arbitrator's decision shall be final and binding on both parties. FinovaOS reserves the right to refine the arbitration process as the platform grows across jurisdictions. We strongly recommend consulting a qualified legal advisor before initiating formal proceedings.",
      },
      {
        sub: "No Class Actions",
        body: "To the extent permitted by applicable law, you agree to resolve any dispute with FinovaOS on an individual basis only, and not as a plaintiff or class member in any class action, collective action, or representative proceeding.",
      },
    ],
  },
  {
    ...
    dim: "rgba(var(--txr-a78bfa, 167,139,250),.08)",
    border: "rgba(167,139,250,.25)",
    title: "Governing Law & Legal Entity",
    content: [
      {
        sub: "Legal Entity",
        body: "FinovaOS™ is a product of Finova Forge. Finova Forge is the legal entity responsible for operating, licensing, and maintaining the FinovaOS platform and all associated services. Legal notices must be addressed in writing to: legal@finovaos.app",
      },
      {
        sub: "Governing Law",
        body: "These Terms of Service shall be governed by and interpreted in accordance with the laws applicable to the jurisdiction in which Finova Forge operates, unless otherwise required by the customer's applicable local laws or mandatory consumer protection regulations. Where jurisdictional conflicts arise, both parties will act in good faith to resolve them.",
      },
      {
        sub: "Severability",
        body: "If any provision of these Terms is found unenforceable or invalid under applicable law, the remaining provisions shall continue in full force and effect. The invalid provision shall be modified to the minimum extent necessary to make it enforceable while preserving the original intent of the parties.",
      },
    ],
  },
  {
    ...
    content: [
      {
        sub: "Updates",
        body: "We may update these Terms from time to time. We will notify you of material changes via email at least 14 days before the changes take effect. Continued use of FinovaOS after the effective date constitutes acceptance of the updated Terms.",
      },
    ],
  },
  {
    ...
    content: [
      {
        sub: "Get in Touch",
        body: "For legal, billing, or privacy questions, contact Finova Forge at: legal@finovaos.app — Finova Forge is the legal entity operating and maintaining the FinovaOS platform.",
      },
    ],
  },
];
        ...
        <section style={{ padding:"80px 24px 48px", maxWidth:1100, margin:"0 auto" }}>
          <div ref={heroRef}>
            <div style={{ display:"flex", alignItems:"center", gap:6, marginBottom:28,
              ...
              <span style={{ fontSize:12, color:"rgba(var(--ink),var(--ta-45, .45))", fontWeight:500 }}>Terms of Service</span>
            </div>
            ...
            <div style={{ display:"flex", alignItems:"flex-start", gap:20, flexWrap:"wrap" }}>
              <div style={{ flex:1, minWidth:280 }}>
                <div style={{
                  ...
                  fontSize:10.5, fontWeight:700, color:"var(--tx-fde68a, #fde68a)",
                ...
                <h1 style={{
                  ...
                  <span style={{ display:"block", fontStyle:"italic",
                    background:"linear-gradient(135deg,var(--tx-fde68a, #fde68a),var(--tx-fbbf24, #fbbf24))",
              ...
              <div style={{
                ...
                {[
                  ...
                  { icon:"📊", text:"You own your financial records" },
                  { icon:"🤖", text:"AI never trains on your data" },
                  { icon:"⚖️", text:"Operated by Finova Forge" },
                ].map(({ icon, text }) => (
                ...
                <div style={{ marginTop:14, paddingTop:14, borderTop:"1px solid rgba(var(--ink),.07)" }}>
                  <div style={{ fontSize:11, color:"rgba(var(--ink),var(--ta-22, .22))", lineHeight:1.6 }}>
                    ...
                    <a href={EMAIL_HREF} rel="noopener noreferrer" style={{ color:"var(--tx-fbbf24, #fbbf24)", textDecoration:"none", fontWeight:600 }}>{EMAIL}</a>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div>
            ...
            <div style={{
              ...
              <a href={EMAIL_HREF} rel="noopener noreferrer" style={{
                ...
                color:"var(--tx-fde68a, #fde68a)", textDecoration:"none", fontSize:13, fontWeight:600,
                marginBottom:18,
              }}>
                📧 {EMAIL}
              </a>
            ...
            <div style={{ marginTop:20, padding:"14px 18px", borderRadius:12,
              ...
              <p style={{ fontSize:12, color:"rgba(var(--ink),var(--ta-30, .3))", lineHeight:1.7, margin:0 }}>
                <span style={{ fontWeight:700, color:"rgba(var(--txr-fbbf24, 251,191,36),var(--ta-60, .6))" }}>Note: </span>
