...
const DEPARTMENTS = [
  ...
  },
  {
    ...
    headcount: 24,
    desc: "We bring Finova to businesses around the world. From inbound leads to enterprise deals — this team owns growth.",
  ...
  },
  {
    ...
    headcount: 16,
    desc: "We make sure every customer gets maximum value from Finova. Zero churn is the goal. Customer obsession is the culture.",
...
const ENGINEERING_LADDER = [
  ...
  },
  {
    ...
    color: "#34d399",
    yoe: "12+ years",
    desc: "You set the technical direction for the entire company. You solve our hardest problems and your influence is felt across all of Finova.",
