...
â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
const FAQS = [
  { q: "How do I sync my bank transactions?", a: "Navigate to Transactions â†’ Integrations â†’ Plaid Bank Connect in your dashboard. We support 10,000+ banks via Plaid. Credentials are encrypted end-to-end and never stored on our servers." },
        ...
        <div style={{ maxWidth: 1160, margin: "0 auto", padding: "64px 24px 100px", position: "relative", zIndex: 1 }}>
          ...
          <div className="sp-fade-1" style={{ textAlign:"center", marginBottom:80 }}>
            ...
            <p style={{ fontSize:17, color:"rgba(255,255,255,.45)", lineHeight:1.75, maxWidth:480, margin:"0 auto" }}>
              Get answers fast, reach our team directly, or dive into our knowledge base â€” we&apos;re here every step of the way.
            </p>
          </div>
          ...
          <div className="sp-fade-3" style={{ display:"grid", gridTemplateColumns:"3fr 2fr", gap:24, marginBottom:88, alignItems:"start" }}>
            ...
            <div style={{ display:"flex", flexDirection:"column", gap:16 }}>
              ...
              <div style={{ borderRadius:20, padding:"24px", background:"rgba(255,255,255,.04)", border:"1.5px solid rgba(255,255,255,.08)", backdropFilter:"blur(16px)", position:"relative", overflow:"hidden" }}>
                ...
                {[
                  { label:"Getting Started Guide", icon:"ðŸ“–", href:"/help/create-account" },
                  { label:"Bank Integration Setup", icon:"ðŸ¦", href:"/help/import-statements" },
                  { label:"Invoice & Billing Docs", icon:"ðŸ§¾", href:"/help/pl-statement" },
                  { label:"Multi-Branch Setup", icon:"ðŸ¢", href:"/help/choose-plan" },
                  { label:"Submit a Support Ticket", icon:"ðŸŽ«", href:"mailto:finovaos.app@gmail.com" },
                ].map(({ label, icon, href }) => (
