...
const PLANS = [
  ...
  },
  {
    ...
    features: [
      ...
      { text: "Integration-ready APIs & webhooks", yes: true  },
...
const DEFAULT_PLAN_HIGHLIGHTS = {
  ...
  enterprise: ["Up to 25 users","Everything in Professional","API access","Integration-ready APIs & webhooks","Multi-currency","Priority support 24/7"],
};
