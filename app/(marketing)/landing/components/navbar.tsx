...
const FEATURES_COLS = [
  {
    ...
    links: [
      ...
      { label: "Balance Sheet",           href: "/features/accounting" },
      { label: "Cash Flow",               href: "/features/accounting" },
      { label: "Tax Summary",             href: "/features/accounting" },
    ],
  },
  {
    ...
    links: [
      ...
      { label: "Stock Reports",          href: "/features/reports" },
      { label: "Customer Accounts",      href: "/features/crm" },
    ],
  },
  {
...
const SOLUTIONS_COLS = [
  {
    ...
    links: [
      ...
      { label: "Wholesale",              href: "/solutions?industry=wholesale",  icon: "📦" },
      { label: "Retail & Multi-Store",   href: "/solutions?industry=retail",     icon: "🏪" },
      { label: "Import / Export",        href: "/solutions?industry=import",     icon: "🚢" },
      { label: "Clearing & Forwarding",  href: "/solutions?industry=clearing_forwarding", icon: "🛃" },
      { label: "Manufacturing",          href: "/solutions?industry=manufacturing", icon: "🏭" },
        ...
        <div style={{ maxWidth:1200, margin:"0 auto", padding:"0 16px" }} className="sm:px-6">
          <div style={{ height:64, display:"flex", alignItems:"center", justifyContent:"space-between" }}>
            ...
            <Link href="/" style={{ display:"flex", alignItems:"center", gap:9, textDecoration:"none" }}>
              <img src="/icon1.png" alt="FinovaOS" width={34} height={34} style={{ width:34, height:34, objectFit:"contain", flexShrink:0 }}/>
