...
const FEATURES_COLS = [
  {
    ...
    color: "#818cf8",
    links: [
      { label: "Ledger & Trial Balance",  href: "/features/ledger-trial-balance" },
      { label: "Profit & Loss",           href: "/features/profit-loss" },
      { label: "Balance Sheet",           href: "/features/balance-sheet" },
      { label: "Cash Flow",               href: "/features/cash-flow" },
      { label: "Tax Summary",             href: "/features/tax-summary" },
    ],
  },
  {
    ...
    color: "#34d399",
    links: [
      { label: "Sales Invoices",         href: "/features/sales-invoices" },
      { label: "Quotations",             href: "/features/quotations" },
      { label: "Inventory Management",   href: "/features/inventory-management" },
      { label: "Stock Reports",          href: "/features/stock-reports" },
      { label: "Customer Accounts",      href: "/features/customer-accounts" },
    ],
  },
  {
    ...
    links: [
      ...
      { label: "Payment Receipts",       href: "/features/payment-receipts" },
      { label: "Payment Vouchers",       href: "/features/payment-vouchers" },
      { label: "Recurring Transactions", href: "/features/recurring-transactions" },
      { label: "Bank Accounts",          href: "/features/bank-accounts" },
    ],
  },
  {
    ...
    color: "#a78bfa",
    links: [
      { label: "AI Financial Insights",   href: "/features/ai-financial-insights" },
      { label: "Ask AI (Chat)",           href: "/demo" },
      { label: "Smart Alerts",            href: "/features/smart-alerts" },
      { label: "Revenue Forecast",        href: "/features/revenue-forecast" },
      { label: "Market Intelligence",     href: "/features/market-intelligence" },
      { label: "AI Business Advisor",     href: "/features/ai-business-advisor" },
    ],
  },
]
...
const SOLUTIONS_COLS = [
  ...
  },
  {
    ...
    color: "#f87171",
    links: [
      { label: "Multi-currency Accounting", href: "/features/multi-currency", icon: "💱" },
      { label: "Global Tax Compliance",     href: "/features/global-tax-compliance", icon: "📋" },
      { label: "Payroll Management",        href: "/features/payroll-management", icon: "👥" },
      { label: "Inventory Tracking",        href: "/features/inventory-management", icon: "📦" },
      { label: "Financial Reporting",       href: "/features/financial-reporting", icon: "📊" },
    ],
  },
]
