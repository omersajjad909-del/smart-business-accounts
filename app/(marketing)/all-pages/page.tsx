...
const SITEMAP = [
  {
    ...
    links: [
      ...
      { label: "Integrations", href: "/integrations", desc: "Payments, banking, messaging & developer connections" },
      { label: "Compare Software", href: "/compare", desc: "FinovaOS vs Xero, Zoho, Wave & QuickBooks" },
      { label: "FAQ", href: "/faq", desc: "Common questions about pricing, accounting & manufacturing" },
