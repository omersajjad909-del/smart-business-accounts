...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: "GDPR compliant. Data privacy first. Trusted by businesses worldwide.",
    url: `${BASE}/trust`,
    siteName: "FinovaOS",
  ...
  twitter: {
    ...
    description: "GDPR compliant. Data privacy first. Trusted by businesses globally.",
