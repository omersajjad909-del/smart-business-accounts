...
const TESTIMONIALS = [
  ...
  },
  {
    ...
    role: "CFO",
    message: "The dashboard gives us instant clarity across all 5 branches. We scaled from 2 to 5 locations with zero chaos and zero extra headcount. Finova just works.",
    rating: 5,
    planUsed: "ENTERPRISE",
    status: "PUBLISHED",
    featured: true,
  },
  {
    ...
    message: "We were running on spreadsheets and prayers. Switching to Finova was the single best operational decision we made this year. Setup took less than a day.",
    rating: 5,
    planUsed: "PROFESSIONAL",
    status: "PUBLISHED",
    featured: true,
  ...
  },
  {
    ...
    role: "Owner",
    message: "Multi-currency support is flawless. We invoice in USD, AED, and PKR — Finova handles exchange rates and gain/loss automatically. Saved us a dedicated accountant.",
    rating: 5,
    planUsed: "ENTERPRISE",
    status: "PUBLISHED",
    featured: false,
